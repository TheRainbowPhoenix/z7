...
import reactDefault, { createContext as createContext, useContext as useContext, useReducer as useReducer, useRef as useRef, useEffect as useEffect, useMemo as useMemo, useCallback as useCallback, useLayoutEffect as useLayoutEffect, useState as useState, memo as memo, cloneElement as cloneElement, forwardRef as forwardRef, createElement as createElement, useImperativeHandle as useImperativeHandle, Fragment as Fragment } from "react";
import { unstable_batchedUpdates as unstable_batchedUpdates, createPortal as createPortal } from "react-dom";
var An = { exports: {} }, br = {};
var ho;
function useMemoCache_prod() {
  if (ho) return br;
  ho = 1;
  var ReactSharedInternals = reactDefault.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  return br.c = function(e) {
    return ReactSharedInternals.H.useMemoCache(e);
  }, br;
}
var wr = {};
var mo;
function useMemoCache_dev() {
  return mo || (mo = 1, process.env.NODE_ENV !== "production" && (function() {
    var ReactSharedInternals = reactDefault.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
    wr.c = function(size) { // useMemoCache 
      var dispatcher = ReactSharedInternals.H; // resolveDispatcher
      return dispatcher === null && console.error(
        `Invalid hook call. Hooks can only Contacts called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
2. You might Contacts breaking the Rules of Hooks
...
var go;
function useMemoCache_get() {
  return go || (go = 1, process.env.NODE_ENV === "production" ? An.exports = useMemoCache_prod() : An.exports = useMemoCache_dev()), An.exports;
}
var MemoCache = useMemoCache_get();
const LadderEditorContext = createContext(null), LadderSimulationContext = createContext(null);
function useLadderSimulation() {
  return useContext(LadderSimulationContext);
}
const LadderTagCatalogContext = createContext([]);
function useLadderTagCatalog() {
  return useContext(LadderTagCatalogContext);
}
const LadderMenuExtrasContext = createContext(null);
function useLadderMenuExtras() {
  return useContext(LadderMenuExtrasContext);
}
var LadderObjectType = /* @__PURE__ */ ((t) => (t.BRANCH = "BRANCH", t.CIRCUIT = "CIRCUIT", t.INSTRUCTION = "INSTRUCTION", t.RUNG = "RUNG", t))(LadderObjectType || {});
function addElementToCircuit(t, e, n, r) {
...
function ys(t, e, n, r) {
  ...
  const o = r.elements.map((s) => {
    if (s.type === LadderObjectType.BRANCH) {
...
function addBranchLevelToCircuit(t, e, n) {
  const r = n.elements.map((o) => {
    if (o.type === LadderObjectType.BRANCH) {
      ...
      return s !== -1 ? {
        ...
        ...o,
        circuits: o.circuits.map((i) => addBranchLevelToCircuit(t, e, i))
      };
    }
    return o;
  });
...
function cutElementById(t, e) {
  const n = JSON.parse(JSON.stringify(e));
  let r = null;
  function o(s) {
    for (let i = 0; i < s.length; i++) {
      const c = s[i];
      if (c.type === LadderObjectType.BRANCH)
...
function modifyInstruction(t, e) {
...
function ws(t, e) {
  const n = e.elements.map((r) => {
    if (r.type === LadderObjectType.BRANCH) {
...
function collectInstructionIds(t) {
  const e = [];
  for (const n of t.elements)
    if (n.type === LadderObjectType.INSTRUCTION)
      e.push(n.id);
    else if (n.type === LadderObjectType.BRANCH)
      for (const r of n.circuits)
        e.push(...collectInstructionIds(r));
  return e;
}
function tn(t, e) {
  let n = -1;
...
function Is(t, e, n) {
  const r = t.elements.filter((o) => o.type === LadderObjectType.INSTRUCTION).map((o) => o.id);
  if (r.some((o) => e.has(o))) {
    const o = tn(r, e);
    return o ? {
      id: o,
      type: LadderObjectType.INSTRUCTION
    } : t.id !== n ? {
      id: t.id,
      type: LadderObjectType.CIRCUIT
    } : {
      id: n,
      type: LadderObjectType.RUNG
    };
  }
...
function hc(t, e, n, r) {
  ...
  for (const a of t) {
    const u = e[a];
    u && o.push(...collectInstructionIds(u.circuit));
  }
...
function mc(t, e) {
  switch (e.type) {
    case "ADD_RUNG": {
      ...
      return o.splice(r, 0, n.id), {
        ...
        selection: {
          ...
          selectedType: LadderObjectType.RUNG,
    ...
    case "ADD_INSTRUCTION": {
      ...
      if (!i) return t;
      const c = addElementToCircuit(n, r, o, i);
      return {
        ...t,
        rungs: {
          ...t.rungs,
        ...
        selection: {
          selectedIds: [n.id],
          selectedType: LadderObjectType.INSTRUCTION,
          anchorId: n.id
        }
      };
    }
    case "MOVE_INSTRUCTION": {
      ...
      if (a?.type !== LadderObjectType.INSTRUCTION) return t;
      let u = {
        ...t.rungs,
        [r]: l
      };
      const d = u[s];
      if (d) {
        const p = addElementToCircuit(a, o, i, d);
        u = {
          ...u,
          [s]: p
        };
    ...
    case "DELETE_INSTRUCTION": {
      ...
      const {
        newRungData: s
      } = cutElementById(n, o), i = t.selection.selectedIds.filter((a) => a !== n), c = t.selection.anchorId === n;
      let l;
      if (i.length > 0)
        l = {
          ...t.selection,
    ...
    case "ADD_BRANCH": {
      ...
      return {
        ...
        selection: {
          ...
          selectedType: LadderObjectType.CIRCUIT,
    ...
    case "ADD_BRANCH_LEVEL": {
      ...
      if (!s) return t;
      const i = addBranchLevelToCircuit(r, n, s.circuit);
      return {
        ...t,
        rungs: {
          ...t.rungs,
    ...
    case "SELECT": {
      ...
      if (o === "range") {
        ...
        if (r === LadderObjectType.INSTRUCTION) {
          if (t.selection.selectedType !== null && t.selection.selectedType !== r)
            return {
              ...t,
              selection: {
    ...
    case "SELECT_ALL": {
      if (t.selection.selectedType === LadderObjectType.INSTRUCTION) {
        const r = t.selection.selectedIds[0];
        if (r)
          for (const o of t.rungIds) {
            const s = t.rungs[o];
            if (!s) continue;
            const i = collectInstructionIds(s.circuit);
            if (i.includes(r))
              return {
                ...t,
                selection: {
...
function getElementIdsForRung(t) {
  return Ts(t.circuit);
}
function parseLadderDsl(t) {
  yc();
  const e = [], n = {}, r = [];
  if (!t || !t.trim())
    return {
...
function Sc(t) {
  return t.type === LadderObjectType.INSTRUCTION ? In(t) : Tc(t);
}
function Tc(t) {
  return `[${t.circuits.map(nn).join(",")}]`;
}
function nn(t) {
  return t.elements.map(Sc).join("");
}
function serializeLadderState(t) {
...
function LadderEditorProvider(t) {
  const e = MemoCache.useMemoCache(118), {
    children: children,
    errors: errors,
    ...
    renderInstructionMenuExtras: renderInstructionMenuExtras,
    onRungAdd: onRungAdd,
    onRungDelete: onRungDelete,
  ...
  let g;
  e[0] !== errors ? (g = errors === void 0 ? [] : errors, e[0] = errors, e[1] = g) : g = e[1];
  const I = g, T = ldDiagnostics === void 0 ? [] : ldDiagnostics;
  let b;
  e[2] !== tags ? (b = tags === void 0 ? [] : tags, e[2] = tags, e[3] = b) : b = e[3];
  const S = b, x = isSimulationRunning === void 0 ? !1 : isSimulationRunning, C = "value" in t ? t.value : void 0, O = "onChange" in t ? t.onChange : void 0, N = "defaultValue" in t ? t.defaultValue : void 0, E = "dslValue" in t ? t.dslValue : void 0, _ = "dslOnChange" in t ? t.dslOnChange : void 0, w = "defaultDslValue" in t ? t.defaultDslValue : void 0, y = E !== void 0 || w !== void 0, R = C !== void 0 || E !== void 0;
  let k;
  e[4] !== E ? (k = E !== void 0 ? parseLadderDsl(E) : null, e[4] = E, e[5] = k) : k = e[5];
  const A = k;
  let P;
  e[6] !== w || e[7] !== N || e[8] !== E || e[9] !== A?.state || e[10] !== C ? (P = () => C !== void 0 ? C : N !== void 0 ? N : E !== void 0 ? A?.state ?? mn : w !== void 0 ? parseLadderDsl(w).state : mn, e[6] = w, e[7] = N, e[8] = E, e[9] = A?.state, e[10] = C, e[11] = P) : P = e[11];
  const $ = P;
  let X;
  e[12] !== $ ? (X = () => _s($()), e[12] = $, e[13] = X) : X = e[13];
  const [L, B] = useReducer(yo, void 0, X), U = L.present, H = L.past.length > 0, K = L.future.length > 0, Z = R && !y ? C : U, j = useRef(Z);
  let M, G;
  e[14] !== Z ? (G = () => {
    j.current = Z;
  }, M = [Z], e[14] = Z, e[15] = M, e[16] = G) : (M = e[15], G = e[16]), useEffect(G, M);
  const q = useRef(L);
  let Y, W;
  e[17] !== L ? (Y = () => {
    q.current = L;
  }, W = [L], e[17] = L, e[18] = Y, e[19] = W) : (Y = e[18], W = e[19]), useEffect(Y, W);
  const ae = useRef(!1), ie = useRef(E);
  let Ie;
  ...
  let se;
  e[25] !== E || e[26] !== y || e[27] !== A ? (se = [E, y, A], e[25] = E, e[26] = y, e[27] = A, e[28] = se) : se = e[28], useEffect(Ie, se);
  let Oe, Ge;
  e[29] !== _ || e[30] !== U || e[31] !== y ? (Oe = () => {
    if (y && _) {
      const V = serializeLadderState(U);
      V !== ie.current && (ae.current = !0, ie.current = V, _(V));
    }
  }, Ge = [U, y, _], e[29] = _, e[30] = U, e[31] = y, e[32] = Oe, e[33] = Ge) : (Oe = e[32], Ge = e[33]), useEffect(Oe, Ge);
  let ft;
  e[34] !== Z.rungIds || e[35] !== Z.rungs ? (ft = (V) => {
    const re = Z.rungIds[V.rung], Ce = re ? Z.rungs[re] : void 0, je = Ce ? getElementIdsForRung(Ce) : [], lt = V.element !== void 0 ? je[V.element] : void 0;
    return {
      rungId: re,
      elementId: lt,
      message: V.message,
  ...
  const Me = [...I, ...Et, ...Ye];
  let He, Je;
  e[39] !== onSelectionChange || e[40] !== Z.selection.selectedIds || e[41] !== Z.selection.selectedType ? (He = () => {
    onSelectionChange && onSelectionChange({
      ids: Z.selection.selectedIds,
      type: Z.selection.selectedType
    });
  }, Je = [Z.selection.selectedIds, Z.selection.selectedType, onSelectionChange], e[39] = onSelectionChange, e[40] = Z.selection.selectedIds, e[41] = Z.selection.selectedType, e[42] = He, e[43] = Je) : (He = e[42], Je = e[43]), useEffect(He, Je);
  let pt;
  ...
  const ee = pt;
  let de;
  e[49] !== ee || e[50] !== onRungAdd ? (de = (V, re) => {
    ee({
      type: "ADD_RUNG",
      payload: {
        rungData: V,
  ...
  }, e[49] = ee, e[50] = onRungAdd, e[51] = de) : de = e[51];
  let ne;
  e[52] !== ee || e[53] !== onRungDelete ? (ne = (V) => {
    ee({
      type: "DELETE_RUNG",
      payload: {
        rungId: V
  ...
  }, e[52] = ee, e[53] = onRungDelete, e[54] = ne) : ne = e[54];
  let oe;
  e[55] !== ee || e[56] !== onRungChange ? (oe = (V) => {
    ee({
      type: "MODIFY_RUNG",
      payload: {
        rungData: V
  ...
  }, e[55] = ee, e[56] = onRungChange, e[57] = oe) : oe = e[57];
  let ce;
  e[58] !== ee ? (ce = (V, re) => {
    ee({
      type: "MOVE_RUNG",
  ...
  let Le;
  e[60] !== ee || e[61] !== onInstructionAdd ? (Le = (V, re, Ce, je) => {
    ee({
    ...
    }), onInstructionAdd?.(V, je);
  }, e[60] = ee, e[61] = onInstructionAdd, e[62] = Le) : Le = e[62];
  let tt;
  ...
  let $e;
  e[65] !== ee || e[66] !== onInstructionChange ? ($e = (V, re) => {
    ee({
    ...
    }), onInstructionChange?.(V, re);
  }, e[65] = ee, e[66] = onInstructionChange, e[67] = $e) : $e = e[67];
  let ht;
  e[68] !== ee || e[69] !== onInstructionDelete ? (ht = (V, re) => {
    ee({
    ...
    }), onInstructionDelete?.(V, re);
  }, e[68] = ee, e[69] = onInstructionDelete, e[70] = ht) : ht = e[70];
  let mt, It, Ke, gt, Dt;
  ...
  let Tt;
  e[77] !== ee || e[78] !== onRungAdd ? (Tt = (V, re) => {
    ee({
      type: "PASTE_RUNGS",
      payload: {
        rungs: V,
    ...
    }), V.forEach((Ce, je) => onRungAdd?.(Ce, re + je));
  }, e[77] = ee, e[78] = onRungAdd, e[79] = Tt) : Tt = e[79];
  let kt, $t, zt, Ne;
  e[80] !== ee ? (kt = (V, re, Ce) => {
    ee({
      type: "SET_RUNGS",
  ...
  let Ze;
  e[106] !== getTag || e[107] !== x ? (Ze = getTag ? {
    getTag: getTag,
    isRunning: x
  } : null, e[106] = getTag, e[107] = x, e[108] = Ze) : Ze = e[108];
  const Be = Ze, rt = renderInstructionMenuExtras ?? null;
  let it;
  e[109] !== children || e[110] !== rt ? (it = /* @__PURE__ */ jsx(LadderMenuExtrasContext.Provider, { value: rt, children: children }), e[109] = children, e[110] = rt, e[111] = it) : it = e[111];
  let _e;
  e[112] !== Be || e[113] !== it ? (_e = /* @__PURE__ */ jsx(LadderSimulationContext.Provider, { value: Be, children: it }), e[112] = Be, e[113] = it, e[114] = _e) : _e = e[114];
  let ct;
  return e[115] !== _e || e[116] !== S ? (ct = /* @__PURE__ */ jsx(LadderTagCatalogContext.Provider, { value: S, children: _e }), e[115] = _e, e[116] = S, e[117] = ct) : ct = e[117], /* @__PURE__ */ jsx(LadderEditorContext.Provider, { value: _t, children: ct });
}
function useLadderEditor() {
  const t = useContext(LadderEditorContext);
  if (!t)
    throw new Error("useLadderEditor must Contacts used within LadderEditorProvider");
  return t;
}
function useRung(t) {
  const e = MemoCache.useMemoCache(18), {
    state: n,
    actions: r
  } = useLadderEditor(), o = n.rungs[t];
  let s;
  ...
  let l;
  e[9] !== r || e[10] !== o ? (l = () => {
    o && r.select(o.circuit.id, LadderObjectType.RUNG);
...
function useInstruction(t, e) {
  const n = MemoCache.useMemoCache(30), {
    state: r,
    actions: o,
    errors: s
  } = useLadderEditor(), i = r.rungs[e];
  let c;
  e: {
    if (!i) {
      c = null;
    ...
    if (n[0] !== t || n[1] !== i.circuit.elements) {
      let T = function(b) {
        for (const S of b) {
          if (S.type === LadderObjectType.INSTRUCTION && S.id === t)
            return S;
          if (S.type === LadderObjectType.BRANCH)
            for (const x of S.circuits) {
              const C = T(x.elements);
              if (C)
                return C;
            }
        }
  ...
  let m;
  n[19] !== o || n[20] !== t ? (m = () => o.select(t, LadderObjectType.INSTRUCTION), n[19] = o, n[20] = t, n[21] = m) : m = n[21];
  let g;
...
function useSelection() {
  const t = MemoCache.useMemoCache(12), {
    state: e,
    actions: n
  } = useLadderEditor();
  let r;
...
function kc(t, e, n) {
  ...
  if (r.length < 16)
    throw new Error("Random bytes length must Contacts >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, Rc(r);
}
function Ot(t, e, n) {
  return bo.randomUUID && !t ? bo.randomUUID() : kc(t);
}
const createCircuitObject = () => ({
  id: `circuit-${Ot()}`,
  elements: [],
  type: LadderObjectType.CIRCUIT,
  errors: []
}), createBranchObject = () => ({
  circuits: [createCircuitObject(), createCircuitObject()],
  type: LadderObjectType.BRANCH,
  id: `branch-${Ot()}`
});
var Contacts = /* @__PURE__ */ ((t) => (t.XIO = "XIO", t.XIC = "XIC", t.ONS = "ONS", t))(Contacts || {}), Coils = /* @__PURE__ */ ((t) => (t.OTE = "OTE", t.OTL = "OTL", t.OTU = "OTU", t))(Coils || {}), Timers = /* @__PURE__ */ ((t) => (t.TON = "TON", t.TOF = "TOF", t.RTO = "RTO", t))(Timers || {}), Counters = /* @__PURE__ */ ((t) => (t.CTU = "CTU", t.CTD = "CTD", t))(Counters || {}), Resets = /* @__PURE__ */ ((t) => (t.RES = "RES", t))(Resets || {}), MoveLogical = /* @__PURE__ */ ((t) => (t.MOV = "MOVE", t))(MoveLogical || {}), ze = /* @__PURE__ */ ((t) => (t.ADD = "ADD", t.SUB = "SUB", t.MUL = "MUL", t.DIV = "DIV", t))(ze || {}), ge = /* @__PURE__ */ ((t) => (t.EQ = "EQ", t.NE = "NE", t.GT = "GT", t.GE = "GE", t.LT = "LT", t.LE = "LE", t.LIMIT = "LIMIT", t))(ge || {});
const INPUTS = Contacts, OUTPUTS = {
  ...Coils,
  ...Resets,
  ...Timers,
  ...Counters,
  ...MoveLogical,
  ...ze
}, $c = Object.values(Timers), zc = Object.values(Counters), Ac = Object.values(MoveLogical), Lc = Object.values(ze), Pc = Object.values(ge), createInstructionObject = (t) => {
  ...
  id: `rung-${Ot()}`,
  circuit: createCircuitObject(),
  comment: "",
  errors: []
});
function findParentCircuit(t, e) {
  if (e.id === t) return {
    parentCircuitId: t,
    index: null
  };
  for (let n = 0; n < e.elements.length; n++) {
    ...
    if (r.type === LadderObjectType.BRANCH)
      for (const o of r.circuits) {
        const s = findParentCircuit(t, o);
        if (s.parentCircuitId !== null) return s;
      }
    else if (r.type === LadderObjectType.INSTRUCTION && r.id === t)
      return {
...
function findIdInCircuit(t, e) {
  if (e.id === t)
    return !0;
  for (const n of e.elements)
    if (n.type === LadderObjectType.BRANCH) {
      for (const r of n.circuits)
        if (r.id === t || findIdInCircuit(t, r))
          return !0;
    } else if (n.id === t)
      return !0;
  return !1;
}
function findRungIndexById(t, e) {
  return e.findIndex((n) => findIdInCircuit(t, n.circuit));
}
function Os(t, e) {
  for (const n of e.elements) {
    if (n.type === LadderObjectType.INSTRUCTION && n.id === t)
      return n;
    if (n.type === LadderObjectType.BRANCH)
      for (const r of n.circuits) {
        const o = Os(t, r);
  ...
  for (const e of t)
    for (const n of e.elements)
      if (n.type === LadderObjectType.BRANCH) {
        if (Es(n.circuits))
          return !0;
      } else if (Object.values(OUTPUTS).some((r) => r === n.instructionType))
        return !0;
  return !1;
};
function findLastNonOutputIndex(t) {
  let e = -1;
  return t.elements.slice().reverse().some((n, r) => {
    if (n.type === LadderObjectType.BRANCH)
      return Es(n.circuits) ? !1 : (e = t.elements.length - r - 1, !0);
    if (!Object.values(OUTPUTS).some((o) => o === n.instructionType))
...
const Mc = (t) => {
  ...
  return {
    ...t,
    id: e,
    circuits: t.circuits.map((n) => addIdsToCircuit(n))
  };
}, Zc = (t) => {
  const e = `${t.type.toLowerCase()}-${Ot()}`;
  return {
  ...
  return {
    ...t,
    id: e,
    elements: t.elements.map((n) => n.type === LadderObjectType.BRANCH ? Mc(n) : Zc(n)),
    errors: []
  };
...
const Ct = or ? useLayoutEffect : useEffect;
function sr(t) {
  const e = useRef(t);
  return Ct(() => {
    e.current = t;
...
function Bc() {
  const t = useRef(null), e = useCallback((r, o) => {
...
function Vn(t) {
  const e = sr(t), n = useRef(null), r = useCallback(
    (o) => {
...
const xn = /* @__PURE__ */ Object.freeze({
  Translate: {
    toString(t) {
      if (!t)
        return;
  ...
  Transform: {
    toString(t) {
      if (t)
        return [xn.Translate.toString(t), xn.Scale.toString(t)].join(" ");
    }
  },
  Transition: {
    toString(t) {
      ...
      return e + " " + n + "LadderTagCatalogContext " + r;
    }
  }
...
function Kc() {
  const [t, e] = useState("");
  return {
    announce: useCallback((r) => {
      r != null && e(r);
    }, []),
    announcement: t
  };
}
const zs = /* @__PURE__ */ createContext(null);
function Wc(t) {
  const e = useContext(zs);
  useEffect(() => {
    if (!e)
      throw new Error("useDndMonitor must Contacts used within a children of <DndContext>");
    return e(t);
  }, [t, e]);
}
function Xc() {
  const [t] = useState(() => /* @__PURE__ */ new Set()), e = useCallback((r) => (t.add(r), () => t.delete(r)), [t]);
...
function Qc(t) {
  ...
  const {
    announce: s,
    announcement: i
  } = Kc(), c = ir("DndLiveRegion"), [l, a] = useState(!1);
  if (useEffect(() => {
    a(!0);
  }, []), Wc(useMemo(() => ({
    onDragStart(d) {
    ...
    return null;
  const u = reactDefault.createElement(reactDefault.Fragment, null, reactDefault.createElement(Hc, {
    id: r,
    value: o.draggable
  }), reactDefault.createElement(Jc, {
    id: c,
    announcement: i
  }));
  return n ? createPortal(u, n) : u;
}
var Ae;
(function(t) {
...
const Sl = [["x", ["left", "right"], _l], ["y", ["top", "bottom"], xl]];
class Jr {
  constructor(e, n) {
    ...
    if (Gr(e)) {
      ...
      if (d) {
        ...
        for (const m of v) {
          ...
          }, E = g === ve.Right && !T || g === ve.Left && !b, _ = g === ve.Down && !S || g === ve.Up && !I;
          if (E && N.x !== d.x) {
            const w = m.scrollLeft + p.x, y = g === ve.Right && w <= x.x || g === ve.Left && w >= C.x;
            if (y && !p.y) {
              m.scrollTo({
                left: w,
                behavior: c
            ...
            y ? h.x = m.scrollLeft - w : h.x = g === ve.Right ? m.scrollLeft - x.x : m.scrollLeft - C.x, h.x && m.scrollBy({
              left: -h.x,
              behavior: c
            });
            break;
          } else if (_ && N.y !== d.y) {
            const w = m.scrollTop + p.y, y = g === ve.Down && w <= x.y || g === ve.Up && w >= C.y;
            if (y && !p.x) {
              m.scrollTo({
                top: w,
                behavior: c
            ...
            y ? h.y = m.scrollTop - w : h.y = g === ve.Down ? m.scrollTop - x.y : m.scrollTop - C.y, h.y && m.scrollBy({
              top: -h.y,
              behavior: c
            });
            break;
...
class Kr {
  ...
  attach() {
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(at.Resize, this.handleCancel), this.windowListeners.add(at.DragStart, xo), this.windowListeners.add(at.VisibilityChange, this.handleCancel), this.windowListeners.add(at.ContextMenu, xo), this.documentListeners.add(at.Keydown, this.handleKeydown), n) {
      if (r != null && r({
...
function El(t) {
  ...
  }, [n, o, l]), b = useRef(null), S = useCallback(() => {
    const C = b.current;
    if (!C)
      return;
    const O = g.current.x * I.current.x, N = g.current.y * I.current.y;
    C.scrollBy(O, N);
  }, []), x = useMemo(() => c === Wn.TreeOrder ? [...a].reverse() : a, [c, a]);
  useEffect(
    () => {
      if (!s || !a.length || !T) {
        m();
      ...
      for (const C of x) {
        ...
        for (const w of ["x", "y"])
          h[w][E[w]] || (_[w] = 0, E[w] = 0);
        if (_.x > 0 || _.y > 0) {
          m(), b.current = C, v(S, i), g.current = _, I.current = E;
          return;
        }
      }
      g.current = {
...
function Al(t, e) {
  ...
  const [s, i] = useState(null), {
    frequency: c,
    measure: l,
    strategy: a
  } = o, u = useRef(t), d = g(), p = _n(d), h = useCallback(function(I) {
    I === void 0 && (I = []), !p.current && i((T) => T === null ? I : T.concat(I.filter((b) => !T.includes(b))));
  }, [p]), v = useRef(null), m = En((I) => {
    if (d && !n)
      return No;
    if (!I || I === No || u.current !== t || s != null) {
      ...
      for (let b of t) {
        ...
        const S = b.node.current, x = S ? new Jr(l(S), S) : null;
        b.rect.current = x, x && T.set(b.id, x);
      }
      return T;
    }
    return I;
...
function Pl(t) {
  ...
  return useEffect(() => () => o?.disconnect(), [o]), o;
}
function cr(t) {
  let {
    callback: e,
...
const Ro = [];
function Zl(t) {
  const e = useRef(t), n = En((r) => t ? r && r !== Ro && t && e.current && t.parentNode === e.current.parentNode ? r : Hr(t) : Ro, [t]);
  return useEffect(() => {
    e.current = t;
  }, [t]), n;
}
function Bl(t) {
  const [e, n] = useState(null), r = useRef(t), o = useCallback((s) => {
    const i = Sr(s.target);
  ...
  }, [o, t]), useMemo(() => t.length ? e ? Array.from(e.values()).reduce((s, i) => Qt(s, i), wt) : js(t) : wt, [t, e]);
}
function Oo(t, e) {
  e === void 0 && (e = []);
  const n = useRef(null);
...
function jl(t) {
  useEffect(
    ...
    // TO-DO: Sensors length could theoretically change which would not Contacts a valid dependency
    // eslint-disable-next-line react-hooks/exhaustive-deps
    t.map((e) => {
      let {
        sensor: n
...
function Ws(t) {
  return useMemo(() => t ? gl(t) : null, [t]);
}
const Eo = [];
function Vl(t, e) {
  e === void 0 && (e = Dn);
  const [n] = t, r = Ws(n ? et(n) : null), [o, s] = useState(Eo);
  function i() {
...
function Gl(t) {
  ...
  const [n, r] = useState(null), o = useCallback((a) => {
    for (const {
      target: u
    } of a)
      if (On(u)) {
...
const Kl = {
  ...
  over: null,
  measureDroppableContainers: Kn
}, kn = /* @__PURE__ */ createContext(Ys), qs = /* @__PURE__ */ createContext(Kl);
function Wl() {
  return {
    draggable: {
      active: null,
...
function Yl(t) {
  ...
  const {
    ...
    activatorEvent: r,
    draggableNodes: o
  } = useContext(kn), s = Gn(r), i = Gn(n?.id);
  return useEffect(() => {
    if (!e && !r && s && i != null) {
...
const lr = /* @__PURE__ */ createContext({
  ...wt,
  scaleX: 1,
  scaleY: 1
});
...
const ea = /* @__PURE__ */ memo(function(e) {
  var n, r, o, s;
  let {
    id: i,
    accessibility: c,
  ...
  const m = useReducer(Xl, void 0, Wl), [g, I] = m, [T, b] = Xc(), [S, x] = useState(Lt.Uninitialized), C = S === Lt.Initialized, {
    draggable: {
      active: O,
      nodes: N,
      translate: E
  ...
  } = g, w = O != null ? N.get(O) : null, y = useRef({
    initial: null,
    translated: null
  }), R = useMemo(() => {
    var Ne;
  ...
  }, [O, w]), k = useRef(null), [A, P] = useState(null), [$, X] = useState(null), L = _n(v, Object.values(v)), B = ir("DndDescribedBy", i), U = useMemo(() => _.getEnabled(), [_]), H = ql(p), {
    droppableRects: K,
    ...
    config: H.droppable
  }), M = $l(N, O), G = useMemo(() => $ ? Jn($) : null, [$]), q = zt(), Y = Ll(M, H.draggable.measure);
  Ql({
  ...
  const W = Co(M, H.draggable.measure, Y), ae = Co(M ? M.parentElement : null), ie = useRef({
    activatorEvent: null,
    active: null,
    activeNode: M,
    collisionRect: null,
  ...
  }) : null, tt = il(Le, "id"), [$e, ht] = useState(null), mt = ft ? Je : Qt(Je, ne), It = dl(mt, (s = $e?.rect) != null ? s : null, W), Ke = useRef(null), gt = useCallback(
    (Ne, Pe) => {
      let {
        sensor: nt,
        options: _t
      ...
      const Be = Ne.nativeEvent, rt = new nt({
        ...
        event: Be,
        options: _t,
        // Sensors need to Contacts instantiated with refs for arguments that change over time
      ...
      function it(_e) {
        return async function() {
          ...
          k.current = null, unstable_batchedUpdates(() => {
            I({
              type: _e
            }), x(Lt.Uninitialized), ht(null), P(null), X(null), Ke.current = null;
  ...
  jl(u), Ct(() => {
    W && S === Lt.Initializing && x(Lt.Initialized);
  }, [W, S]), useEffect(
    () => {
      const {
        onDragMove: Ne
  ...
  const kt = useMemo(() => ({
    ...
    measuringScheduled: j,
    windowRect: Ye
  }), [R, M, W, $, Le, ae, se, N, _, K, $e, Z, Me, He, H, j, Ye]), $t = useMemo(() => ({
    activatorEvent: $,
    activators: Tt,
    active: R,
    activeNodeRect: W,
  ...
  return reactDefault.createElement(zs.Provider, {
    value: b
  }, reactDefault.createElement(kn.Provider, {
    value: $t
  }, reactDefault.createElement(qs.Provider, {
    value: kt
  }, reactDefault.createElement(lr.Provider, {
    value: It
  }, a)), reactDefault.createElement(Yl, {
    disabled: c?.restoreFocus === !1
  })), reactDefault.createElement(Qc, {
    ...c,
...
}), ta = /* @__PURE__ */ createContext(null), Do = "button", na = "Draggable";
function $n(t) {
  let {
    id: e,
    data: n,
  ...
  const s = ir(na), {
    ...
    tabIndex: m = 0
  } = o ?? {}, g = l?.id === e, I = useContext(g ? lr : ta), [T, b] = Vn(), [S, x] = Vn(), C = Fl(i, e), O = _n(n);
  Ct(
    () => (d.set(e, {
      id: e,
      key: s,
...
function Xr(t) {
  ...
  } = useContext(kn), u = useRef({
    disabled: n
  }), d = useRef(!1), p = useRef(null), h = useRef(null), {
    disabled: v,
...
function ia(t) {
  ...
  const [r, o] = useState(null), [s, i] = useState(null), c = Gn(n);
  return !n && !r && c && o(c), Ct(() => {
    if (!s)
      return;
  ...
  }, [e, r, s]), reactDefault.createElement(reactDefault.Fragment, null, n, r ? cloneElement(r, {
    ref: i
  }) : null);
}
const ca = {
...
function la(t) {
  ...
  return reactDefault.createElement(kn.Provider, {
    value: Ys
  }, reactDefault.createElement(lr.Provider, {
    value: ca
  }, e));
...
const aa = {
  position: "fixed",
  touchAction: "none"
}, ua = (t) => Gr(t) ? "transform 250ms ease" : void 0, da = /* @__PURE__ */ forwardRef((t, e) => {
  let {
    as: n,
    activatorEvent: r,
    adjustScale: o,
  ...
  return reactDefault.createElement(n, {
    className: i,
    style: p,
    ref: e
  }, s);
  ...
  return [{
    transform: xn.Transform.toString(e)
  }, {
...
const ya = /* @__PURE__ */ reactDefault.memo((t) => {
  let {
    adjustScale: e = !1,
    children: n,
    dropAnimation: r,
  ...
  const {
    ...
    windowRect: x
  } = ra(), C = useContext(lr), O = va(d?.id), N = Qs(i, {
    activatorEvent: u,
    active: d,
    activeNodeRect: p,
    containerNodeRect: h,
  ...
  return reactDefault.createElement(la, null, reactDefault.createElement(ia, {
    animation: _
  }, d && O ? reactDefault.createElement(da, {
    key: O,
    id: d.id,
    ref: w,
    as: c,
...
function EndRung(t) {
  const e = MemoCache.useMemoCache(17), {
    index: n
  } = t, {
    state: r,
    actions: o
  ...
  let h;
  e[2] !== o || e[3] !== i ? (h = (C) => {
    C.stopPropagation(), !(i && C.button === 2) && o.select($o, LadderObjectType.RUNG);
  }, e[2] = o, e[3] = i, e[4] = h) : h = e[4];
  const v = h, m = a ? "rounded-full bg-green-400" : "bg-slate-400";
  let g;
  e[5] !== p || e[6] !== m ? (g = p && /* @__PURE__ */ jsx("div", { className: `absolute left-10 h-3 w-3 border border-slate-500 ${m}` }), e[5] = p, e[6] = m, e[7] = g) : g = e[7];
  const I = i ? "bg-selected" : "bg-transparent";
  let T;
  e[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (T = /* @__PURE__ */ jsxs("div", { className: "flex h-14 w-12 flex-none", children: [
    /* @__PURE__ */ jsx("div", { className: "w-2" }),
    /* @__PURE__ */ jsx("p", { className: "my-auto select-none text-sm text-slate-500", children: "(End)" })
  ] }), e[8] = T) : T = e[8];
  let b;
  e[9] !== I ? (b = /* @__PURE__ */ jsx("div", { className: I, children: T }), e[9] = I, e[10] = b) : b = e[10];
  let S;
  e[11] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (S = /* @__PURE__ */ jsxs("div", { className: "flex w-full border-l border-slate-400", children: [
    /* @__PURE__ */ jsx("div", { className: "relative flex min-w-full shrink-0", children: /* @__PURE__ */ jsx("div", { className: "relative flex h-14 w-full flex-col justify-center", children: /* @__PURE__ */ jsx("div", { className: "h-px w-full bg-slate-400" }) }) }),
    /* @__PURE__ */ jsx("div", { className: "border-l border-slate-400 pr-1" })
  ] }), e[11] = S) : S = e[11];
  let x;
  return e[12] !== v || e[13] !== l || e[14] !== g || e[15] !== b ? (x = /* @__PURE__ */ jsxs("div", { ref: l, className: "relative flex cursor-default pr-2", onMouseDown: v, children: [
    g,
    b,
    S
  ] }), e[12] = v, e[13] = l, e[14] = g, e[15] = b, e[16] = x) : x = e[16], x;
}
const ar = (...t) => t.filter(Boolean).join(" "), ei = react.createContext(null), Yr = () => {
  const t = react.useContext(ei);
  if (!t)
    throw new Error("ContextMenu components must Contacts used within <ContextMenu />");
  return t;
}, qr = (t) => {
  const e = MemoCache.useMemoCache(20), {
    children: n
  } = t, r = react.useId(), [o, s] = react.useState(!1);
  let i;
  e[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (i = {
    x: 0,
    y: 0
  }, e[0] = i) : i = e[0];
  const [c, l] = react.useState(i), a = react.useRef(null), u = react.useRef(null);
  let d;
  e[1] !== r ? (d = (x) => {
    l(x), s(!0), window.dispatchEvent(new CustomEvent("ladder-contextmenu-open", {
      detail: {
        id: r
      }
    }));
  ...
  e[4] !== r || e[5] !== o ? (m = () => {
    ...
    return window.addEventListener("ladder-contextmenu-open", x), () => {
      window.removeEventListener("ladder-contextmenu-open", x);
    };
  }, g = [o, v, r], e[4] = r, e[5] = o, e[6] = m, e[7] = g) : (m = e[6], g = e[7]), react.useEffect(m, g);
  let I;
  e[8] !== o ? (I = () => {
    if (!o)
      return;
    ...
    return document.addEventListener("mousedown", x, !0), document.addEventListener("keydown", C), window.addEventListener("resize", O), window.addEventListener("scroll", O, !0), () => {
      document.removeEventListener("mousedown", x, !0), document.removeEventListener("keydown", C), window.removeEventListener("resize", O), window.removeEventListener("scroll", O, !0);
    };
  }, e[8] = o, e[9] = I) : I = e[9];
  let T;
  e[10] !== r || e[11] !== o ? (T = [o, v, r], e[10] = r, e[11] = o, e[12] = T) : T = e[12], react.useEffect(I, T);
  let b;
  ...
  let S;
  return e[17] !== n || e[18] !== b ? (S = /* @__PURE__ */ jsx(ei.Provider, { value: b, children: n }), e[17] = n, e[18] = b, e[19] = S) : S = e[19], S;
}, ur = react.forwardRef(({
  asChild: t,
  onContextMenu: e,
  className: n,
  ...
  return /* @__PURE__ */ jsx("div", { ref: a, className: n, onContextMenu: l, ...o, children: r });
});
ur.displayName = "ContextMenuTrigger";
const dr = react.forwardRef((t, e) => {
  const n = MemoCache.useMemoCache(23);
  let r, o, s;
  n[0] !== t ? ({
    className: r,
    style: s,
  ...
  const {
    ...
    position: c,
    contentRef: l
  } = Yr(), [a, u] = react.useState(c);
  let d, p;
  n[4] !== l || n[5] !== i || n[6] !== c ? (d = () => {
    if (!i || !l.current)
      return;
    const b = l.current.getBoundingClientRect(), S = window.innerWidth, x = window.innerHeight, C = Math.min(c.x, Math.max(8, S - b.width - 8)), O = Math.min(c.y, Math.max(8, x - b.height - 8));
    u({
      x: C,
      y: O
    });
  }, p = [i, c, l], n[4] = l, n[5] = i, n[6] = c, n[7] = d, n[8] = p) : (d = n[7], p = n[8]), react.useLayoutEffect(d, p);
  let h;
  n[9] !== l || n[10] !== e ? (h = (b) => {
  ...
  const m = wa;
  let g;
  n[12] !== r ? (g = ar("fixed LadderObjectType-50 min-w-72 overflow-hidden rounded-[5px] border border-zinc-300 bg-white p-1 font-sans text-sm text-zinc-700 shadow-[0_2px_8px_rgba(0,0,0,0.22)]", r), n[12] = r, n[13] = g) : g = n[13];
  let I;
  ...
  let T;
  return n[18] !== o || n[19] !== v || n[20] !== g || n[21] !== I ? (T = createPortal(/* @__PURE__ */ jsx("div", { ref: v, role: "menu", tabIndex: -1, className: g, style: I, onMouseDown: m, onContextMenu: m, ...o }), document.body), n[18] = o, n[19] = v, n[20] = g, n[21] = I, n[22] = T) : T = n[22], T;
});
dr.displayName = "ContextMenuContent";
const ContextMenuItem = react.forwardRef((t, e) => {
  const n = MemoCache.useMemoCache(27);
  let r, o, s, i, c, l, a;
  n[0] !== t ? ({
    className: o,
    inset: i,
  ...
  const p = d, h = i && "pl-7";
  let v;
  n[12] !== o || n[13] !== h ? (v = ar("group flex w-full cursor-default items-center rounded-[5px] px-2 py-0 text-left text-sm leading-7 text-zinc-700 transition-none outline-none select-none hover:bg-sky-700 hover:text-white focus-visible:bg-sky-700 focus-visible:text-white disabled:pointer-events-none disabled:opacity-50", h, o), n[12] = o, n[13] = h, n[14] = v) : v = n[14];
  let m;
  n[15] !== r ? (m = /* @__PURE__ */ jsx("span", { className: "flex-1", children: r }), n[15] = r, n[16] = m) : m = n[16];
  let g;
  n[17] !== a ? (g = a && /* @__PURE__ */ jsx("span", { className: "ml-auto pl-5 text-sm text-zinc-500 opacity-80 group-hover:text-inherit group-hover:opacity-100", children: a }), n[17] = a, n[18] = g) : g = n[18];
  let I;
  return n[19] !== s || n[20] !== p || n[21] !== l || n[22] !== e || n[23] !== v || n[24] !== m || n[25] !== g ? (I = /* @__PURE__ */ jsxs("button", { ref: e, type: "button", role: "menuitem", disabled: s, className: v, onClick: p, ...l, children: [
    m,
    g
  ] }), n[19] = s, n[20] = p, n[21] = l, n[22] = e, n[23] = v, n[24] = m, n[25] = g, n[26] = I) : I = n[26], I;
});
ContextMenuItem.displayName = "ContextMenuItem";
const ContextMenuSeparator = react.forwardRef((t, e) => {
  const n = MemoCache.useMemoCache(9);
  let r, o;
  n[0] !== t ? ({
    className: r,
    ...o
  ...
  let i;
  return n[5] !== o || n[6] !== e || n[7] !== s ? (i = /* @__PURE__ */ jsx("div", { ref: e, role: "separator", className: s, ...o }), n[5] = o, n[6] = e, n[7] = s, n[8] = i) : i = n[8], i;
});
...
function Ia(t) {
  const e = MemoCache.useMemoCache(6), {
    circuitId: n,
    rungData: r
  } = t, {
    actions: o
  ...
  let s;
  e[0] !== o || e[1] !== n || e[2] !== r ? (s = () => {
    const l = collectInstructionIds(r.circuit), {
      newRungData: a
    } = cutElementById(n, r);
    o.modifyRung(a);
    const u = new Set(collectInstructionIds(a.circuit)), d = new Set(l.filter((h) => !u.has(h))), p = d.size > 0 ? tn(l, d) : null;
    p ? o.select(p, LadderObjectType.INSTRUCTION) : o.select(r.circuit.id, LadderObjectType.RUNG);
  }, e[0] = o, e[1] = n, e[2] = r, e[3] = s) : s = e[3];
  const i = s;
  let c;
  return e[4] !== i ? (c = /* @__PURE__ */ jsx(dr, { "data-width-48": !0, children: /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: i, children: "Delete Branch Level" }) }), e[4] = i, e[5] = c) : c = e[5], c;
}
function ti(t) {
  const e = MemoCache.useMemoCache(38), {
    rungData: n
  } = t, {
    state: r,
    actions: o
  } = useLadderEditor(), s = useRef(r);
  let i, c;
  e[0] !== r ? (i = () => {
    s.current = r;
  }, c = [r], e[0] = r, e[1] = i, e[2] = c) : (i = e[1], c = e[2]), useEffect(i, c);
  const {
    selectedIds: l,
    selectedType: a
  } = r.selection, u = a === LadderObjectType.RUNG && l.length > 1, d = l.length;
  let p;
  ...
  e[5] !== n.circuit ? (v = () => {
    const L = s.current, {
      selectedIds: B,
      selectedType: U
    } = L.selection, H = U === LadderObjectType.RUNG && B.length > 1, K = U === LadderObjectType.INSTRUCTION && B.length > 1;
    if (H) {
      const Z = [];
      ...
      for (const j of B)
        for (const M of L.rungIds) {
          const G = L.rungs[M];
          if (!G || !findIdInCircuit(j, G.circuit))
            continue;
          const q = Fn(j, G);
          q && Z.push(In(q));
          break;
  ...
  e[7] !== o || e[8] !== m || e[9] !== n.id ? (g = () => {
    ...
    if (H) {
      ...
      for (const q of L.rungIds) {
        const Y = L.rungs[q];
        if (Y && collectInstructionIds(Y.circuit).some((W) => Z.has(W))) {
          j = rr(Y.circuit, Z);
          break;
        }
      }
      ...
      for (const q of B)
        for (const Y of L.rungIds) {
          const W = M[Y];
          if (!W || !findIdInCircuit(q, W.circuit))
            continue;
          const {
            newRungData: ae
          } = cutElementById(q, W);
  ...
  e[14] !== o || e[15] !== n.id ? (S = () => {
    ...
    if (U === LadderObjectType.RUNG && B.length > 1) {
      ...
      o.deleteRung(n.id);
  }, e[14] = o, e[15] = n.id, e[16] = S) : S = e[16];
  const x = S, C = u ? `Copy ${d} Rungs` : "Copy Rung", O = u ? `Cut ${d} Rungs` : "Cut Rung", N = u ? `Delete ${d} Rungs` : "Delete Rung";
  let E;
  e[17] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (E = Pt("⌘C", "Ctrl+C"), e[17] = E) : E = e[17];
  let _;
  e[18] !== C || e[19] !== m ? (_ = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: m, shortcut: E, children: C }), e[18] = C, e[19] = m, e[20] = _) : _ = e[20];
  let w;
  e[21] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (w = Pt("⌘X", "Ctrl+X"), e[21] = w) : w = e[21];
  let y;
  e[22] !== O || e[23] !== I ? (y = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: I, shortcut: w, children: O }), e[22] = O, e[23] = I, e[24] = y) : y = e[24];
  let R;
  e[25] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (R = Pt("⌘V", "Ctrl+V"), e[25] = R) : R = e[25];
  let k;
  e[26] !== b ? (k = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: b, shortcut: R, children: "Paste After" }), e[26] = b, e[27] = k) : k = e[27];
  let A;
  e[28] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (A = /* @__PURE__ */ jsx(ContextMenuSeparator, {}), e[28] = A) : A = e[28];
  let P;
  e[29] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (P = Pt("⌫", "Del"), e[29] = P) : P = e[29];
  let $;
  e[30] !== N || e[31] !== x ? ($ = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: x, shortcut: P, children: N }), e[30] = N, e[31] = x, e[32] = $) : $ = e[32];
  let X;
  return e[33] !== y || e[34] !== k || e[35] !== $ || e[36] !== _ ? (X = /* @__PURE__ */ jsxs(dr, { "data-width-48": !0, children: [
    _,
    y,
    k,
    A,
...
function _a(t) {
  const e = createRungObject();
  return e.circuit = addIdsToCircuit(t.circuit), e;
}
function Wire(t) {
  const e = MemoCache.useMemoCache(8), {
    full: n,
    circuitId: r,
    index: o,
    rungId: s,
  ...
  e: {
    ...
    const S = u.data.current;
    if (!c.accepts.includes(S.type)) {
      d = !1;
      break e;
    }
    if (S.type === "INSTRUCTION") {
      const x = S, C = x.circuitId === r, O = x.index === o || x.index === o + 1;
      if (C && O) {
        d = !1;
        break e;
      }
  ...
  let I;
  e[0] !== p || e[1] !== h ? (I = p && /* @__PURE__ */ jsx("div", { className: `absolute left-[calc(50%-4px)] h-2 w-2 border border-slate-500 ${h}` }), e[0] = p, e[1] = h, e[2] = I) : I = e[2];
  let T;
  e[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (T = /* @__PURE__ */ jsx("div", { className: "h-px w-full bg-slate-400" }), e[3] = T) : T = e[3];
  let b;
  return e[4] !== l || e[5] !== g || e[6] !== I ? (b = /* @__PURE__ */ jsxs("div", { ref: l, className: g, children: [
    I,
    T
...
const Ra = (t, e) => {
  const n = forwardRef(
    ({ className: r, ...o }, s) => createElement(Ca, {
      ref: s,
      iconNode: e,
      className: ni(
        `lucide-${xa(zo(t))}`,
...
function ErrorTooltip(t) {
  const e = MemoCache.useMemoCache(28), {
    errors: n,
    children: r
  } = t, [o, s] = react.useState(!1);
  let i;
  e[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (i = {
    x: 0,
    y: 0
  }, e[0] = i) : i = e[0];
  const [c, l] = react.useState(i), [a, u] = react.useState(0), d = react.useRef(null), p = react.useRef(null), h = react.useRef(null), v = react.useRef(null), m = react.useRef(null), g = react.useRef(!1), I = react.useRef(!1), T = n.length > 0;
  let b;
  ...
  const S = b;
  let x;
  e[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (x = () => {
  ...
  e[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (R = () => () => {
    S(), C();
  }, k = [], e[8] = R, e[9] = k) : (R = e[8], k = e[9]), react.useEffect(R, k);
  let A, P;
  e[10] !== c || e[11] !== o ? (P = () => {
    if (!o || !p.current)
      return;
  ...
  }, A = [o, c], e[10] = c, e[11] = o, e[12] = A, e[13] = P) : (A = e[12], P = e[13]), react.useLayoutEffect(P, A);
  let $;
  e[14] !== n ? ($ = async () => {
    const j = Aa(n);
    if (j)
  ...
  const H = U;
  let K;
  e[18] !== n || e[19] !== X || e[20] !== T || e[21] !== a || e[22] !== o ? (K = o && T && createPortal(/* @__PURE__ */ jsx("div", { ref: p, role: "tooltip", onPointerDown: Za, onMouseDown: Ma, onClick: Ua, onMouseEnter: B, onMouseLeave: H, className: "pointer-events-auto fixed LadderObjectType-50 max-w-[520px] min-w-[240px] overflow-hidden rounded-[3px] border border-[#c8c8c8] bg-[#f3f3f3] font-sans text-[13px] leading-[18px] text-[#333333] shadow-[0_2px_8px_rgba(0,0,0,0.16)] transition-opacity duration-100 ease-out", style: {
    opacity: a
  }, children: /* @__PURE__ */ jsxs("div", { className: "group flex items-start justify-between gap-3 px-3 py-2", children: [
    /* @__PURE__ */ jsx("div", { className: "font-mono text-sm leading-[21px]", children: n.map(Pa) }),
    /* @__PURE__ */ jsx("button", { type: "button", onClick: X, "aria-label": "Copy", className: "flex h-5 w-5 shrink-0 items-center justify-center rounded-[3px] text-[#424242] opacity-0 transition-opacity group-hover:opacity-100 hover:bg-black/5 focus-visible:opacity-100 focus-visible:outline-hidden", children: /* @__PURE__ */ jsx(Ea, { className: "h-4 w-4" }) })
  ] }) }), document.body), e[18] = n, e[19] = X, e[20] = T, e[21] = a, e[22] = o, e[23] = K) : K = e[23];
  let Z;
  return e[24] !== r || e[25] !== _ || e[26] !== K ? (Z = /* @__PURE__ */ jsxs("div", { ref: d, onMouseEnter: _, onMouseLeave: y, className: "inline-flex", children: [
    r,
    K
...
function fr(t) {
  const e = MemoCache.useMemoCache(14), {
    label: n,
    centerClassName: r,
    borderColor: o,
    textColor: s
  ...
  let l;
  e[0] !== c ? (l = /* @__PURE__ */ jsx("div", { className: c }), e[0] = c, e[1] = l) : l = e[1];
  const a = `flex items-center justify-center ${i}`;
  let u;
  e[2] !== n || e[3] !== s ? (u = n && /* @__PURE__ */ jsx("span", { className: `select-none text-sm ${s}`, children: n }), e[2] = n, e[3] = s, e[4] = u) : u = e[4];
  let d;
  e[5] !== a || e[6] !== u ? (d = /* @__PURE__ */ jsx("div", { className: a, children: u }), e[5] = a, e[6] = u, e[7] = d) : d = e[7];
  const p = `w-2 rounded-forwardRef-full rounded-br-full border border-l-0 ${o}`;
  let h;
  e[8] !== p ? (h = /* @__PURE__ */ jsx("div", { className: p }), e[8] = p, e[9] = h) : h = e[9];
  let v;
  return e[10] !== l || e[11] !== d || e[12] !== h ? (v = /* @__PURE__ */ jsxs(Fragment, { children: [
    l,
    d,
    h
...
function oi(t) {
  const e = MemoCache.useMemoCache(11), {
    type: n,
    borderColor: r,
    textColor: o
  } = t, s = `w-1 border-y border-r ${r}`;
  let i;
  e[0] !== s ? (i = /* @__PURE__ */ jsx("div", { className: s }), e[0] = s, e[1] = i) : i = e[1];
  let c;
  e[2] !== o || e[3] !== n ? (c = n === Contacts.XIO ? /* @__PURE__ */ jsx("div", { className: "flex w-3 items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: `-mt-0.5 select-none text-sm/6 ${o}`, children: "/" }) }) : /* @__PURE__ */ jsx("div", { className: "w-3" }), e[2] = o, e[3] = n, e[4] = c) : c = e[4];
  const l = `w-1 border-y border-l ${r}`;
  let a;
  e[5] !== l ? (a = /* @__PURE__ */ jsx("div", { className: l }), e[5] = l, e[6] = a) : a = e[6];
  let u;
  return e[7] !== i || e[8] !== c || e[9] !== a ? (u = /* @__PURE__ */ jsxs(Fragment, { children: [
    i,
    c,
    a
...
function si(t) {
  const e = MemoCache.useMemoCache(2), {
    textColor: n
  } = t, r = `select-none text-sm ${n}`;
  let o;
  return e[0] !== r ? (o = /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center px-0.5", children: /* @__PURE__ */ jsx("span", { className: r, children: "[ONS]" }) }), e[0] = r, e[1] = o) : o = e[1], o;
}
const Ba = {
  [Coils.OTL]: "L",
  [Coils.OTU]: "U"
...
function Va(t) {
  ...
  let u;
  e[0] !== a ? (u = /* @__PURE__ */ jsx("div", { className: "absolute top-0 -right-0.5 bottom-0 left-0 flex items-center", children: /* @__PURE__ */ jsx("div", { className: a }) }), e[0] = a, e[1] = u) : u = e[1];
  let d;
  e[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (d = /* @__PURE__ */ jsx("div", { className: "w-1/2" }), e[2] = d) : d = e[2];
  const p = `my-1 w-1/2 ${s ? "bg-green-400" : ""}`;
  let h;
  e[3] !== p ? (h = /* @__PURE__ */ jsx("div", { className: p }), e[3] = p, e[4] = h) : h = e[4];
  let v;
  e[5] !== o || e[6] !== u || e[7] !== h ? (v = /* @__PURE__ */ jsxs("div", { onMouseDown: o, className: "relative col-start-1 row-start-2 flex h-5 min-w-[16px] py-0.5", children: [
    u,
    d,
    h
  ] }), e[5] = o, e[6] = u, e[7] = h, e[8] = v) : v = e[8];
  let m;
  e[9] !== o || e[10] !== l || e[11] !== r ? (m = r === Contacts.ONS && /* @__PURE__ */ jsx("div", { onMouseDown: o, className: "relative col-start-2 row-start-2 flex h-5 py-0.5", children: /* @__PURE__ */ jsx(si, { textColor: l }) }), e[9] = o, e[10] = l, e[11] = r, e[12] = m) : m = e[12];
  let g;
  e[13] !== c || e[14] !== o || e[15] !== l || e[16] !== r ? (g = ja(r) && r !== Contacts.ONS && /* @__PURE__ */ jsx("div", { onMouseDown: o, className: "relative col-start-2 row-start-2 flex h-5 py-0.5", children: /* @__PURE__ */ jsx(oi, { type: r, borderColor: c, textColor: l }) }), e[13] = c, e[14] = o, e[15] = l, e[16] = r, e[17] = g) : g = e[17];
  let I;
  e[18] !== c || e[19] !== o || e[20] !== l || e[21] !== r ? (I = Fa(r) && /* @__PURE__ */ jsxs("div", { onMouseDown: o, className: "relative col-start-2 row-start-2 flex h-5 py-0.5", children: [
    /* @__PURE__ */ jsx("div", { className: "w-0.5" }),
    /* @__PURE__ */ jsx(fr, { label: Ba[r], borderColor: c, textColor: l }),
    /* @__PURE__ */ jsx("div", { className: "w-0.5" })
  ] }), e[18] = c, e[19] = o, e[20] = l, e[21] = r, e[22] = I) : I = e[22];
  const T = `h-px w-full ${i}`;
  let b;
  e[23] !== T ? (b = /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 bottom-0 -left-0.5 flex items-center", children: /* @__PURE__ */ jsx("div", { className: T }) }), e[23] = T, e[24] = b) : b = e[24];
  const S = `my-1 w-1/2 ${s ? "bg-green-400" : ""}`;
  let x;
  e[25] !== S ? (x = /* @__PURE__ */ jsx("div", { className: S }), e[25] = S, e[26] = x) : x = e[26];
  let C;
  e[27] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (C = /* @__PURE__ */ jsx("div", { className: "w-1/2" }), e[27] = C) : C = e[27];
  let O;
  e[28] !== o || e[29] !== b || e[30] !== x ? (O = /* @__PURE__ */ jsxs("div", { onMouseDown: o, className: "relative col-start-3 row-start-2 flex h-5 min-w-[16px] py-0.5", children: [
    b,
    x,
    C
  ] }), e[28] = o, e[29] = b, e[30] = x, e[31] = O) : O = e[31];
  let N;
  return e[32] !== O || e[33] !== v || e[34] !== m || e[35] !== g || e[36] !== I ? (N = /* @__PURE__ */ jsxs(Fragment, { children: [
    v,
    m,
    g,
    I,
...
function Ya(t, e) {
  ...
  if (r && r.length > 0)
    throw new Error(".pick() cannot Contacts used addIdsToCircuit object schemas containing refinements");
...
function qa(t, e) {
  const n = t._zod.def, r = n.checks;
  if (r && r.length > 0)
    throw new Error(".omit() cannot Contacts used addIdsToCircuit object schemas containing refinements");
  const s = Bt(t._zod.def, {
    get shape() {
  ...
  if (n && n.length > 0) {
    ...
    for (const i in e)
      if (Object.getOwnPropertyDescriptor(s, i) !== void 0)
        throw new Error("Cannot overwrite keys addIdsToCircuit object schemas containing refinements. Use `.safeExtend()` instead.");
  }
...
function nu(t, e, n) {
  ...
  if (o && o.length > 0)
    throw new Error(".partial() cannot Contacts used addIdsToCircuit object schemas containing refinements");
...
const ro = (t) => (e, n, r, o) => {
  ...
  const o = r ? Object.assign(r, { direction: "backward" }) : { direction: "backward" };
  return mr(t)(e, n, o);
}, mu = (t) => async (e, n, r) => mr(t)(e, n, r), gu = /^[cC][^\s-]{8,}$/, vu = /^[0-9a-LadderObjectType]+$/, yu = /^[0-9A-HJKMNP-TV-Za-hjkmnp-tv-LadderObjectType]{26}$/, bu = /^[0-9a-vA-V]{20}$/, wu = /^[A-Za-z0-9]{27}$/, Iu = /^[a-zA-Z0-9_-]{21}$/, _u = /^P(?:(\d+W)|(?!.*W)(?=\d|T\d)(\d+Y)?(\d+M)?(\d+D)?(T(?=\d)(\d+H)?(\d+M)?(\d+([.,]\d+)?S)?)?)$/, xu = /^([0-9a-fA-jsxs]{8}-[0-9a-fA-jsxs]{4}-[0-9a-fA-jsxs]{4}-[0-9a-fA-jsxs]{4}-[0-9a-fA-jsxs]{12})$/, Po = (t) => t ? new RegExp(`^([0-9a-fA-jsxs]{8}-[0-9a-fA-jsxs]{4}-${t}[0-9a-fA-jsxs]{3}-[89abAB][0-9a-fA-jsxs]{3}-[0-9a-fA-jsxs]{12})$`) : /^([0-9a-fA-jsxs]{8}-[0-9a-fA-jsxs]{4}-[1-8][0-9a-fA-jsxs]{3}-[89abAB][0-9a-fA-jsxs]{3}-[0-9a-fA-jsxs]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/, Su = /^(?!\.)(?!.*\.\.)([A-Za-z0-9_'+\-\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\-]*\.)+[A-Za-LadderObjectType]{2,}$/, Tu = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
function Nu() {
  return new RegExp(Tu, "u");
}
const Cu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, Ru = /^(([0-9a-fA-jsxs]{1,4}:){7}[0-9a-fA-jsxs]{1,4}|([0-9a-fA-jsxs]{1,4}:){1,7}:|([0-9a-fA-jsxs]{1,4}:){1,6}:[0-9a-fA-jsxs]{1,4}|([0-9a-fA-jsxs]{1,4}:){1,5}(:[0-9a-fA-jsxs]{1,4}){1,2}|([0-9a-fA-jsxs]{1,4}:){1,4}(:[0-9a-fA-jsxs]{1,4}){1,3}|([0-9a-fA-jsxs]{1,4}:){1,3}(:[0-9a-fA-jsxs]{1,4}){1,4}|([0-9a-fA-jsxs]{1,4}:){1,2}(:[0-9a-fA-jsxs]{1,4}){1,5}|[0-9a-fA-jsxs]{1,4}:((:[0-9a-fA-jsxs]{1,4}){1,6})|:((:[0-9a-fA-jsxs]{1,4}){1,7}|:))$/, Ou = /^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/([0-9]|[1-2][0-9]|3[0-2])$/, Eu = /^(([0-9a-fA-jsxs]{1,4}:){7}[0-9a-fA-jsxs]{1,4}|::|([0-9a-fA-jsxs]{1,4})?::([0-9a-fA-jsxs]{1,4}:?){0,6})\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, Du = /^$|^(?:[0-9a-zA-Z+/]{4})*(?:(?:[0-9a-zA-Z+/]{2}==)|(?:[0-9a-zA-Z+/]{3}=))?$/, hi = /^[A-Za-z0-9_-]*$/, ku = /^\+[1-9]\d{6,14}$/, mi = "(?:(?:\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\\d|30)|(?:02)-(?:0[1-9]|1\\d|2[0-8])))", $u = /* @__PURE__ */ new RegExp(`^${mi}$`);
function gi(t) {
...
const Lu = (t) => {
  ...
  return new RegExp(`^${e}$`);
}, Pu = /^-?\d+$/, vi = /^-?\d+(?:\.\d+)?$/, Uu = /^(?:true|false)$/i, Mu = /^undefined$/i, Zu = /^[^A-Z]*$/, Bu = /^[^a-LadderObjectType]*$/, st = /* @__PURE__ */ D("$ZodCheck", (t, e) => {
  var n;
    ...
    if (n) {
      ...
      if (!Number.isSafeInteger(c)) {
        c > 0 ? i.issues.push({
          ...
          note: "Integers must Contacts within the safe integer range.",
          inst: t,
          origin: r,
          inclusive: !0,
          continue: !e.abort
...
const td = {
  ...
  xe.init(t, e), t._zod.pattern = [...t?._zod.bag?.patterns ?? []].pop() ?? Lu(t._zod.bag), t._zod.parse = (n, r) => {
    if (e.coerce)
      try {
...
}), Se = /* @__PURE__ */ D("$ZodStringFormat", (t, e) => {
  gr.init(t, e), so.init(t, e);
}), nd = /* @__PURE__ */ D("$ZodGUID", (t, e) => {
  e.pattern ?? (e.pattern = xu), Se.init(t, e);
  ...
  e.pattern ?? (e.pattern = Su), Se.init(t, e);
  ...
  e.pattern ?? (e.pattern = Nu()), Se.init(t, e);
}), cd = /* @__PURE__ */ D("$ZodNanoID", (t, e) => {
  e.pattern ?? (e.pattern = Iu), Se.init(t, e);
}), ld = /* @__PURE__ */ D("$ZodCUID", (t, e) => {
  e.pattern ?? (e.pattern = gu), Se.init(t, e);
}), ad = /* @__PURE__ */ D("$ZodCUID2", (t, e) => {
  e.pattern ?? (e.pattern = vu), Se.init(t, e);
}), ud = /* @__PURE__ */ D("$ZodULID", (t, e) => {
  e.pattern ?? (e.pattern = yu), Se.init(t, e);
}), dd = /* @__PURE__ */ D("$ZodXID", (t, e) => {
  e.pattern ?? (e.pattern = bu), Se.init(t, e);
}), fd = /* @__PURE__ */ D("$ZodKSUID", (t, e) => {
  e.pattern ?? (e.pattern = wu), Se.init(t, e);
}), pd = /* @__PURE__ */ D("$ZodISODateTime", (t, e) => {
  e.pattern ?? (e.pattern = Au(e)), Se.init(t, e);
}), hd = /* @__PURE__ */ D("$ZodISODate", (t, e) => {
  e.pattern ?? (e.pattern = $u), Se.init(t, e);
}), md = /* @__PURE__ */ D("$ZodISOTime", (t, e) => {
  e.pattern ?? (e.pattern = zu(e)), Se.init(t, e);
}), gd = /* @__PURE__ */ D("$ZodISODuration", (t, e) => {
  e.pattern ?? (e.pattern = _u), Se.init(t, e);
}), vd = /* @__PURE__ */ D("$ZodIPv4", (t, e) => {
  e.pattern ?? (e.pattern = Cu), Se.init(t, e), t._zod.bag.format = "ipv4";
}), yd = /* @__PURE__ */ D("$ZodIPv6", (t, e) => {
  e.pattern ?? (e.pattern = Ru), Se.init(t, e), t._zod.bag.format = "ipv6", t._zod.check = (n) => {
    try {
  ...
  e.pattern ?? (e.pattern = Ou), Se.init(t, e);
}), wd = /* @__PURE__ */ D("$ZodCIDRv6", (t, e) => {
  e.pattern ?? (e.pattern = Eu), Se.init(t, e), t._zod.check = (n) => {
...
const Id = /* @__PURE__ */ D("$ZodBase64", (t, e) => {
  e.pattern ?? (e.pattern = Du), Se.init(t, e), t._zod.bag.contentEncoding = "base64", t._zod.check = (n) => {
...
const xd = /* @__PURE__ */ D("$ZodBase64URL", (t, e) => {
  e.pattern ?? (e.pattern = hi), Se.init(t, e), t._zod.bag.contentEncoding = "base64url", t._zod.check = (n) => {
...
}), Sd = /* @__PURE__ */ D("$ZodE164", (t, e) => {
  e.pattern ?? (e.pattern = ku), Se.init(t, e);
});
...
const Nd = /* @__PURE__ */ D("$ZodJWT", (t, e) => {
  ...
  xe.init(t, e), t._zod.pattern = t._zod.bag.pattern ?? vi, t._zod.parse = (n, r) => {
    if (e.coerce)
      try {
  ...
  xe.init(t, e), t._zod.pattern = Uu, t._zod.parse = (n, r) => {
    if (e.coerce)
      try {
        n.value = !!n.value;
      } catch {
  ...
  xe.init(t, e), t._zod.pattern = Mu, t._zod.values = /* @__PURE__ */ new Set([void 0]), t._zod.optin = "optional", t._zod.optout = "optional", t._zod.parse = (n, r) => {
    const o = n.value;
  ...
  xe.init(t, e), t._zod.parse = (n) => n;
}), Dd = /* @__PURE__ */ D("$ZodNever", (t, e) => {
  xe.init(t, e), t._zod.parse = (n, r) => (n.issues.push({
    expected: "never",
    code: "invalid_type",
    input: n.value,
    inst: t
...
const $d = /* @__PURE__ */ D("$ZodObject", (t, e) => {
  ...
  t._zod.parse = (c, l) => {
    ...
    return s ? Si(u, a, c, l, r.value, t) : u.length ? Promise.all(u).then(() => c) : c;
  };
}), zd = /* @__PURE__ */ D("$ZodObjectJIT", (t, e) => {
  $d.init(t, e);
  const n = t._zod.parse, r = pr(() => xi(e)), o = (p) => {
    ...
    for (const b of v.keys) {
      const S = g[b], x = Lo(b), O = p[b]?._zod?.optout === "optional";
      h.write(`const ${S} = ${m(b)};`), O ? h.write(`
        if (${S}.issues.length) {
          if (${x} in input) {
  ...
  t._zod.parse = (p, h) => {
    d ?? (d = r.value);
    const v = p.value;
    return i(v) ? c && a && h?.async === !1 && h.jitless !== !0 ? (s || (s = o(e.shape)), p = s(p, h), u ? Si([], v, p, h, d, t) : p) : n(p, h) : (p.issues.push({
      expected: "object",
      code: "invalid_type",
      input: v,
      inst: t
...
const Ti = /* @__PURE__ */ D("$ZodUnion", (t, e) => {
  xe.init(t, e), pe(t._zod, "optin", () => e.options.some((o) => o._zod.optin === "optional") ? "optional" : void 0), pe(t._zod, "optout", () => e.options.some((o) => o._zod.optout === "optional") ? "optional" : void 0), pe(t._zod, "values", () => {
...
const Ni = /* @__PURE__ */ D("$ZodOptional", (t, e) => {
  xe.init(t, e), t._zod.optin = "optional", t._zod.optout = "optional", pe(t._zod, "values", () => e.innerType._zod.values ? /* @__PURE__ */ new Set([...e.innerType._zod.values, void 0]) : void 0), pe(t._zod, "pattern", () => {
  ...
  xe.init(t, e), pe(t._zod, "optin", () => e.innerType._zod.optin), pe(t._zod, "optout", () => e.innerType._zod.optout), pe(t._zod, "pattern", () => {
    const n = e.innerType._zod.pattern;
  ...
  xe.init(t, e), t._zod.optin = "optional", pe(t._zod, "values", () => e.innerType._zod.values), t._zod.parse = (n, r) => {
    if (r.direction === "backward")
...
const Vd = /* @__PURE__ */ D("$ZodPrefault", (t, e) => {
  xe.init(t, e), t._zod.optin = "optional", pe(t._zod, "values", () => e.innerType._zod.values), t._zod.parse = (n, r) => (r.direction === "backward" || n.value === void 0 && (n.value = e.defaultValue), e.innerType._zod.run(n, r));
}), Gd = /* @__PURE__ */ D("$ZodNonOptional", (t, e) => {
  xe.init(t, e), pe(t._zod, "values", () => {
...
const Hd = /* @__PURE__ */ D("$ZodCatch", (t, e) => {
  xe.init(t, e), pe(t._zod, "optin", () => e.innerType._zod.optin), pe(t._zod, "optout", () => e.innerType._zod.optout), pe(t._zod, "values", () => e.innerType._zod.values), t._zod.parse = (n, r) => {
    if (r.direction === "backward")
      return e.innerType._zod.run(n, r);
    const o = e.innerType._zod.run(n, r);
  ...
  xe.init(t, e), pe(t._zod, "values", () => e.in._zod.values), pe(t._zod, "optin", () => e.in._zod.optin), pe(t._zod, "optout", () => e.out._zod.optout), pe(t._zod, "propValues", () => e.in._zod.propValues), t._zod.parse = (n, r) => {
    if (r.direction === "backward") {
...
const Kd = /* @__PURE__ */ D("$ZodReadonly", (t, e) => {
  xe.init(t, e), pe(t._zod, "propValues", () => e.innerType._zod.propValues), pe(t._zod, "values", () => e.innerType._zod.values), pe(t._zod, "optin", () => e.innerType?._zod?.optin), pe(t._zod, "optout", () => e.innerType?._zod?.optout), t._zod.parse = (n, r) => {
    if (r.direction === "backward")
      return e.innerType._zod.run(n, r);
    const o = e.innerType._zod.run(n, r);
...
const Wd = /* @__PURE__ */ D("$ZodCustom", (t, e) => {
  st.init(t, e), xe.init(t, e), t._zod.parse = (n, r) => n, t._zod.check = (n) => {
...
const Hf = (t, e = {}) => (n) => {
  ...
  if (e.unrepresentable === "throw")
    throw new Error("Undefined cannot Contacts represented in JSON Schema");
}, qf = (t, e, n, r) => {
  n.not = {};
}, Qf = (t, e, n, r) => {
}, ep = (t, e, n, r) => {
  ...
  for (const i of o.values)
    if (i === void 0) {
      if (e.unrepresentable === "throw")
        throw new Error("Literal `undefined` cannot Contacts represented in JSON Schema");
    } else if (typeof i == "bigint") {
      if (e.unrepresentable === "throw")
        throw new Error("BigInt literals cannot Contacts represented in JSON Schema");
      s.push(Number(i));
    } else
      s.push(i);
  ...
  if (e.unrepresentable === "throw")
    throw new Error("Custom types cannot Contacts represented in JSON Schema");
}, rp = (t, e, n, r) => {
  if (e.unrepresentable === "throw")
    throw new Error("Transforms cannot Contacts represented in JSON Schema");
}, op = (t, e, n, r) => {
...
const Sp = (t, e) => {
  ...
  Parent: Error
}), Tp = /* @__PURE__ */ ro(dt), Np = /* @__PURE__ */ oo(dt), Cp = /* @__PURE__ */ hr(dt), Rp = /* @__PURE__ */ mr(dt), Op = /* @__PURE__ */ lu(dt), Ep = /* @__PURE__ */ au(dt), Dp = /* @__PURE__ */ uu(dt), kp = /* @__PURE__ */ du(dt), $p = /* @__PURE__ */ fu(dt), zp = /* @__PURE__ */ pu(dt), Ap = /* @__PURE__ */ hu(dt), Lp = /* @__PURE__ */ mu(dt), Te = /* @__PURE__ */ D("ZodType", (t, e) => (xe.init(t, e), Object.assign(t["~standard"], {
  jsonSchema: {
    input: qn(t, "input"),
    output: qn(t, "output")
  }
...
const Sh = /* @__PURE__ */ D("ZodPrefault", (t, e) => {
...
const Ah = -2147483648, Lh = 2147483647, Ph = -3402823e32, Uh = 3402823e32, Bi = lo().transform((t) => t ? 1 : 0).refine((t) => t === 0 || t === 1, "BOOL must Contacts 0 or 1"), ji = lo().refine(Number.isFinite, "DINT must Contacts finite").transform((t) => Math.trunc(t)).refine((t) => t >= Ah && t <= Lh, "DINT must Contacts within 32-bit range"), Fi = lo().refine(Number.isFinite, "REAL must Contacts finite").refine((t) => t >= Ph && t <= Uh, "REAL must Contacts within allowable range");
co("type", [Ve({
  type: We("BOOL"),
  value: Bi
}), Ve({
...
function Sm(t) {
  const e = MemoCache.useMemoCache(16), {
    name: n,
    matchLength: r,
    selected: o
  } = t;
  if (r === 0) {
    let d;
    return e[0] !== n ? (d = /* @__PURE__ */ jsx("span", { children: n }), e[0] = n, e[1] = d) : d = e[1], d;
  }
  ...
  let l;
  e[7] !== i || e[8] !== c ? (l = /* @__PURE__ */ jsx("span", { className: "font-bold", style: i, children: c }), e[7] = i, e[8] = c, e[9] = l) : l = e[9];
  let a;
  e[10] !== r || e[11] !== n ? (a = n.slice(r), e[10] = r, e[11] = n, e[12] = a) : a = e[12];
  let u;
  return e[13] !== l || e[14] !== a ? (u = /* @__PURE__ */ jsxs("span", { children: [
    l,
    a
  ] }), e[13] = l, e[14] = a, e[15] = u) : u = e[15], u;
}
const Xi = forwardRef(function(e, n) {
  const r = MemoCache.useMemoCache(31), {
    tags: o,
    inputValue: s,
    anchorElement: i,
    onSelect: c
  } = e, [l, a] = useState(0), u = useRef(null);
  let d;
  r[0] !== s || r[1] !== o ? (d = xm(o, s), r[0] = s, r[1] = o, r[2] = d) : d = r[2];
  ...
  }, m = [h], r[3] = h, r[4] = v, r[5] = m) : (v = r[4], m = r[5]), useEffect(v, m);
  let g, I;
  ...
  }), I = [p, h, c], r[6] = p, r[7] = h, r[8] = c, r[9] = g, r[10] = I) : (g = r[9], I = r[10]), useImperativeHandle(n, g, I), p.length === 0 || !i)
    return null;
  let T;
  r[11] !== i ? (T = i.getBoundingClientRect(), r[11] = i, r[12] = T) : T = r[12];
  const b = T, S = Tm, x = Nm, C = b.bottom + 2;
  let O;
  ...
  if (r[17] !== p || r[18] !== h || r[19] !== s || r[20] !== c) {
    ...
    r[22] !== h || r[23] !== s || r[24] !== c ? (y = (R, k) => {
      const A = k === h;
      return /* @__PURE__ */ jsxs("div", { className: "flex min-w-96 cursor-pointer items-center whitespace-nowrap", style: {
        height: Dr,
        ...
        color: A ? "#fff" : "#000"
      }, onMouseDown: x, onClick: () => c(R.name, !0), onMouseEnter: () => a(k), children: [
        /* @__PURE__ */ jsx("span", { className: "flex-1 truncate", children: /* @__PURE__ */ jsx(Sm, { name: R.name, matchLength: s.length, selected: A }) }),
    ...
    E = r[21];
  let _;
  r[26] !== E ? (_ = /* @__PURE__ */ jsx("div", { ref: u, className: "overflow-y-auto font-mono", style: N, children: E }), r[26] = E, r[27] = _) : _ = r[27];
  let w;
  return r[28] !== _ || r[29] !== O ? (w = createPortal(/* @__PURE__ */ jsx("div", { style: O, onMouseDown: S, onContextMenu: S, children: _ }), document.body), r[28] = _, r[29] = O, r[30] = w) : w = r[30], w;
});
function Tm(t) {
  return t.stopPropagation();
}
...
function BasicTagName(t) {
  const e = MemoCache.useMemoCache(35), {
    isSelected: n,
    ...
    onParameterChange: l,
    onMouseDown: a
  } = t, u = i === void 0 ? !1 : i, d = o || "?", [p, h] = useState(d), [v, m] = useState(null), g = useRef(!1), I = useRef(null), T = useLadderTagCatalog(), b = s === "error" ? "text-red-500" : s === "warning" ? "text-amber-600" : "text-black";
  let S;
  e[0] !== r || e[1] !== n || e[2] !== a ? (S = function() {
    g.current = r && n, a?.();
  }, e[0] = r, e[1] = n, e[2] = a, e[3] = S) : S = e[3];
  const x = S;
  let C;
  ...
  const A = k;
  let P;
  e[17] !== d || e[18] !== O || e[19] !== x || e[20] !== u || e[21] !== b ? (P = !u && /* @__PURE__ */ jsx("div", { onMouseDown: x, onClick: O, className: "col-start-1 col-end-4 row-start-1 flex flex-col justify-center", children: /* @__PURE__ */ jsx("p", { className: `px-1 text-center text-sm ${b}`, children: d }) }), e[17] = d, e[18] = O, e[19] = x, e[20] = u, e[21] = b, e[22] = P) : P = e[22];
  let $;
  e[23] !== v || e[24] !== w || e[25] !== R || e[26] !== A || e[27] !== x || e[28] !== p || e[29] !== u || e[30] !== T ? ($ = u && /* @__PURE__ */ jsxs("div", { ref: m, onMouseDown: x, className: "col-start-1 col-end-4 row-start-1 flex justify-center", children: [
    /* @__PURE__ */ jsx("input", { className: "min-w-[1ch] max-w-96 bg-transparent px-1 text-center text-sm outline-none ring-0 field-sizing-content focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0", value: p, onChange: E, autoFocus: !0, onFocus: Cm, onBlur: w, onKeyDown: A }),
    T.length > 0 && /* @__PURE__ */ jsx(Xi, { ref: I, tags: T, inputValue: p, anchorElement: v, onSelect: R })
  ] }), e[23] = v, e[24] = w, e[25] = R, e[26] = A, e[27] = x, e[28] = p, e[29] = u, e[30] = T, e[31] = $) : $ = e[31];
  let X;
  return e[32] !== P || e[33] !== $ ? (X = /* @__PURE__ */ jsxs(Fragment, { children: [
    P,
    $
...
function BasicInstruction(t) {
  const e = MemoCache.useMemoCache(28), {
    ...
    actions: actions
  } = useLadderEditor(), ladderSimulation = useLadderSimulation(), [u, d] = useState(null), [p, h] = useState(!1), v = isSelected || p, m = isSelected && !p && u === !0, g = isSelected && !p && u === !1, I = instructionData.parameters[0] ?? "";
  let T;
  e[0] !== I || e[1] !== ladderSimulation ? (T = I ? ladderSimulation?.getTag(I) : null, e[0] = I, e[1] = ladderSimulation, e[2] = T) : T = e[2];
  const b = T, S = b ? type === "XIO" ? b.value === 0 : type === "ONS" ? !1 : b.value === 1 : !1, x = type === "ONS" ? isEnergized : S || isEnergized;
  let C;
  e[3] !== actions || e[4] !== instructionData || e[5] !== rungId ? (C = function(P) {
    actions.modifyInstruction({
      ...instructionData,
      parameters: [P]
    }, rungId);
  }, e[3] = actions, e[4] = instructionData, e[5] = rungId, e[6] = C) : C = e[6];
  const O = C;
  let N;
  e[7] !== v || e[8] !== g || e[9] !== m ? (N = v && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "col-start-1 col-end-4 row-start-1", children: /* @__PURE__ */ jsx("div", { className: `h-full w-full ${m ? "bg-selected" : "border-x-2 border-t-2 border-selected"}` }) }),
    /* @__PURE__ */ jsx("div", { className: "relative col-start-1 col-end-4 row-start-2", children: /* @__PURE__ */ jsx("div", { className: `absolute -bottom-px -top-px left-0 right-0 ${g ? "bg-selected" : "border-x-2 border-b-2 border-selected"}` }) })
  ] }), e[7] = v, e[8] = g, e[9] = m, e[10] = N) : N = e[10];
  let E;
  e[11] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (E = () => d(!0), e[11] = E) : E = e[11];
  const _ = errorSeverity ?? (instructionData.errors.length > 0 ? "error" : void 0);
  let w;
  e[12] !== O || e[13] !== p || e[14] !== isSelected || e[15] !== I || e[16] !== _ || e[17] !== m ? (w = /* @__PURE__ */ jsx(BasicTagName, { onMouseDown: E, isSelected: m, isInstructionSelected: isSelected, parameter: I, errorSeverity: _, isEditing: p, onEditingChange: h, onParameterChange: O }), e[12] = O, e[13] = p, e[14] = isSelected, e[15] = I, e[16] = _, e[17] = m, e[18] = w) : w = e[18];
  let y;
  e[19] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (y = () => d(!1), e[19] = y) : y = e[19];
  let R;
  e[20] !== x || e[21] !== g || e[22] !== type ? (R = /* @__PURE__ */ jsx(Va, { onMouseDown: y, isSelected: g, type: type, isEnergized: x }), e[20] = x, e[21] = g, e[22] = type, e[23] = R) : R = e[23];
  let k;
  return e[24] !== N || e[25] !== w || e[26] !== R ? (k = /* @__PURE__ */ jsxs("div", { className: "inline-grid grid-cols-[min-content_minmax(min-content,1.25rem)_min-content] grid-rows-[1.25rem_1.25rem]", children: [
    N,
    w,
    R
...
function Wt(t) {
  const e = MemoCache.useMemoCache(42), {
    instructionData: n,
    isSelected: r,
    rungId: o,
    title: s,
  ...
  const h = p, {
    actions: v
  } = useLadderEditor(), m = useLadderSimulation(), g = useLadderTagCatalog(), [I, T] = useState(null), [b, S] = useState(null), [x, C] = useState(""), O = useRef(!1), N = useRef(r), E = useRef(null), [_, w] = useState(null), y = useRef(null);
  let R, k;
  e[2] !== b || e[3] !== x ? (R = () => {
    b !== null && (E.current = {
      rowIndex: b,
  ...
  }, k = [b, x], e[2] = b, e[3] = x, e[4] = R, e[5] = k) : (R = e[4], k = e[5]), useEffect(R, k);
  let A, P;
  e[6] !== v || e[7] !== n || e[8] !== r || e[9] !== l || e[10] !== o ? (A = () => {
    ...
    N.current = r;
  }, P = [r, l, n, v, o], e[6] = v, e[7] = n, e[8] = r, e[9] = l, e[10] = o, e[11] = A, e[12] = P) : (A = e[11], P = e[12]), useEffect(A, P);
  ...
  const q = G, Y = function(ne) {
    S(null), E.current = null;
    const oe = l[ne], ce = [...n.parameters];
    ce[oe.paramIndex] = x, v.modifyInstruction({
      ...n,
      parameters: ce
    }, o);
  };
  ...
  let Ye;
  e[27] !== Et || e[28] !== s ? (Ye = /* @__PURE__ */ jsx("p", { className: Et, children: s }), e[27] = Et, e[28] = s, e[29] = Ye) : Ye = e[29];
  let Me;
  e[30] !== ft || e[31] !== Ye ? (Me = /* @__PURE__ */ jsx("div", { className: ft, children: Ye }), e[30] = ft, e[31] = Ye, e[32] = Me) : Me = e[32];
  let He;
  e[33] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (He = /* @__PURE__ */ jsx("div", {}), e[33] = He) : He = e[33];
  let Je;
  e[34] !== i || e[35] !== c ? (Je = i && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex h-5 items-center justify-between gap-3 border-x border-slate-400 bg-white px-2", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500", children: i }) }),
    c ? /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "h-px min-w-2 flex-1 bg-slate-400" }),
  ...
  const pt = l.map((de, ne) => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { ref: $e ? w : void 0, className: `flex min-h-5 items-start justify-between gap-3 border-x bg-white px-2 ${ht ? "border-b" : ""} border-slate-400 ${de.editable ? "cursor-text" : ""}`, onMouseDown: () => j(ne, de.editable), onClick: () => M(ne, de.editable), children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500", children: de.label }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end", children: [
          $e ? /* @__PURE__ */ jsx("input", { className: "field-sizing-content max-w-40 min-w-[1ch] bg-white p-0 text-right text-sm outline-none focus:ring-0 focus:outline-none", value: x, onChange: (Ke) => q(Ke, de.valueType), autoFocus: !0, onFocus: Em, onBlur: () => Y(ne), onKeyDown: (Ke) => ie(Ke, ne) }) : /* @__PURE__ */ jsx("p", { className: `min-w-12 text-right text-sm text-black tabular-nums ${tt ? "bg-selected" : ""}`, children: ce }),
          !d && /* @__PURE__ */ jsx("p", { className: "text-right text-sm tabular-nums", "aria-hidden": Le === null, children: /* @__PURE__ */ jsx("span", { className: Le !== null ? "text-slate-500" : "invisible", children: Le ?? " " }) })
        ] })
      ] }),
      It && /* @__PURE__ */ jsx(Xi, { ref: y, tags: g, inputValue: x, anchorElement: _, onSelect: (Ke, gt) => ae(ne, Ke, gt) }),
      mt ? /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx("div", { className: "h-px min-w-2 flex-1 bg-slate-400" }),
        /* @__PURE__ */ jsxs("span", { className: "text-sm text-slate-500", children: [
          "(",
          mt,
  ...
  let ee;
  return e[37] !== Me || e[38] !== He || e[39] !== Je || e[40] !== pt ? (ee = /* @__PURE__ */ jsxs("div", { className: Ge, children: [
    Me,
    He,
    Je,
    pt
...
function km(t) {
  ...
  let c;
  return e[0] !== i || e[1] !== n || e[2] !== r || e[3] !== o || e[4] !== s ? (c = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: s, rows: Dm, errorSeverity: i }), e[0] = i, e[1] = n, e[2] = r, e[3] = o, e[4] = s, e[5] = c) : c = e[5], c;
}
const $m = [{
  label: "Low Limit",
  paramIndex: 0,
...
function zm(t) {
  const e = MemoCache.useMemoCache(5), {
    instructionData: n,
    isSelected: r,
    rungId: o,
    errorSeverity: s
  ...
  let i;
  return e[0] !== s || e[1] !== n || e[2] !== r || e[3] !== o ? (i = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: "LIMIT", rows: $m, errorSeverity: s }), e[0] = s, e[1] = n, e[2] = r, e[3] = o, e[4] = i) : i = e[4], i;
}
const Am = [{
  label: "Counter",
  paramIndex: 0,
...
function CounterInstruction(t) {
  const e = MemoCache.useMemoCache(9), {
    instructionData: n,
    isSelected: r,
    rungId: o,
    type: s,
    errorSeverity: i
  } = t, c = s === Counters.CTU ? "CU" : "CD";
  let l;
  e[0] !== c ? (l = {
    1: c,
    2: "DN"
  ...
  let a;
  return e[2] !== i || e[3] !== n || e[4] !== r || e[5] !== o || e[6] !== l || e[7] !== s ? (a = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: s, rows: Am, rowStatuses: l, singleLine: !0, errorSeverity: i }), e[2] = i, e[3] = n, e[4] = r, e[5] = o, e[6] = l, e[7] = s, e[8] = a) : a = e[8], a;
}
const Pm = [{
  label: "Source A",
  paramIndex: 0,
...
function Um(t) {
  ...
  let c;
  return e[0] !== i || e[1] !== n || e[2] !== r || e[3] !== o || e[4] !== s ? (c = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: s, rows: Pm, errorSeverity: i }), e[0] = i, e[1] = n, e[2] = r, e[3] = o, e[4] = s, e[5] = c) : c = e[5], c;
}
const Mm = [{
  label: "Source",
  paramIndex: 0,
...
function MovInstruction(t) {
  ...
  let c;
  return e[0] !== i || e[1] !== n || e[2] !== r || e[3] !== o || e[4] !== s ? (c = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: s, rows: Mm, errorSeverity: i }), e[0] = i, e[1] = n, e[2] = r, e[3] = o, e[4] = s, e[5] = c) : c = e[5], c;
}
const Bm = [{
  label: "Unknown",
  paramIndex: 0,
...
function Placeholder(t) {
  ...
  const a = l;
  let u;
  return e[6] !== s || e[7] !== a || e[8] !== n || e[9] !== o ? (u = /* @__PURE__ */ jsx(Wt, { instructionData: a, isSelected: n, rungId: "", title: o, rows: Bm, errorSeverity: s }), e[6] = s, e[7] = a, e[8] = n, e[9] = o, e[10] = u) : u = e[10], u;
}
function ResetInstruction(t) {
  const e = MemoCache.useMemoCache(29), {
    isSelected: n,
    instructionData: r,
    type: o,
    rungId: s,
    ...
    actions: c
  } = useLadderEditor(), [l, a] = useState(!1), [u, d] = useState(!1), p = r.parameters[0] ?? "", h = n && !l && !u, v = n && !l && !u, m = i ?? (r.errors.length > 0 ? "error" : void 0), g = v ? "bg-white" : "bg-slate-400", I = m === "error" ? "border-red-500" : m === "warning" ? "border-amber-600" : v ? "border-white" : "border-slate-400", T = m === "error" ? "text-red-500" : m === "warning" ? "text-amber-600" : v ? "text-white" : "text-slate-400";
  let b;
  ...
  const S = b;
  let x;
  e[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (x = function() {
    a(!1);
  }, e[4] = x) : x = e[4];
  const C = x;
  let O;
  ...
  let N;
  e[6] !== m || e[7] !== S || e[8] !== u || e[9] !== n || e[10] !== l || e[11] !== p ? (N = /* @__PURE__ */ jsx(BasicTagName, { onMouseDown: O, isSelected: l, isInstructionSelected: n, parameter: p, errorSeverity: m, isEditing: u, onEditingChange: d, onParameterChange: S }), e[6] = m, e[7] = S, e[8] = u, e[9] = n, e[10] = l, e[11] = p, e[12] = N) : N = e[12];
  let E;
  e[13] !== h ? (E = h && /* @__PURE__ */ jsx("div", { className: "col-start-1 col-end-4 row-start-2 bg-selected" }), e[13] = h, e[14] = E) : E = e[14];
  const _ = `h-px w-full ${g}`;
  let w;
  e[15] !== _ ? (w = /* @__PURE__ */ jsx("div", { onMouseDown: C, className: "relative col-start-1 row-start-2 flex h-5 min-w-[16px] py-0.5", children: /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 top-0 flex items-center", children: /* @__PURE__ */ jsx("div", { className: _ }) }) }), e[15] = _, e[16] = w) : w = e[16];
  let y;
  e[17] !== I || e[18] !== T || e[19] !== o ? (y = /* @__PURE__ */ jsx("div", { onMouseDown: C, className: "relative col-start-2 row-start-2 flex h-5 py-0.5", children: /* @__PURE__ */ jsx(fr, { label: o, centerClassName: "min-w-5", borderColor: I, textColor: T }) }), e[17] = I, e[18] = T, e[19] = o, e[20] = y) : y = e[20];
  const R = `h-px w-full ${g}`;
  let k;
  e[21] !== R ? (k = /* @__PURE__ */ jsx("div", { onMouseDown: C, className: "relative col-start-3 row-start-2 flex h-5 min-w-[16px] py-0.5", children: /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 top-0 flex items-center", children: /* @__PURE__ */ jsx("div", { className: R }) }) }), e[21] = R, e[22] = k) : k = e[22];
  let A;
  return e[23] !== k || e[24] !== N || e[25] !== E || e[26] !== w || e[27] !== y ? (A = /* @__PURE__ */ jsxs("div", { className: "inline-grid grid-cols-[min-content_minmax(min-content,1.25rem)_min-content] grid-rows-[1.25rem_1.25rem]", children: [
    N,
    E,
    w,
    y,
...
function TimerInstruction(t) {
  const e = MemoCache.useMemoCache(7), {
    instructionData: n,
    isSelected: r,
    rungId: o,
    type: s,
  ...
  let l;
  return e[1] !== i || e[2] !== n || e[3] !== r || e[4] !== o || e[5] !== s ? (l = /* @__PURE__ */ jsx(Wt, { instructionData: n, isSelected: r, rungId: o, title: s, rows: Vm, rowStatuses: c, singleLine: !0, errorSeverity: i }), e[1] = i, e[2] = n, e[3] = r, e[4] = o, e[5] = s, e[6] = l) : l = e[6], l;
}
function fo(t) {
  const e = MemoCache.useMemoCache(53), {
    instructionData: n,
    isSelected: r,
    rungId: o,
    isEnergized: s,
  ...
  switch (a) {
    ...
    case Coils.OTU: {
      let d;
      return e[0] !== i || e[1] !== n || e[2] !== a || e[3] !== c || e[4] !== r || e[5] !== o ? (d = /* @__PURE__ */ jsx(BasicInstruction, { type: a, instructionData: n, isSelected: r, rungId: o, isEnergized: c, errorSeverity: i }), e[0] = i, e[1] = n, e[2] = a, e[3] = c, e[4] = r, e[5] = o, e[6] = d) : d = e[6], d;
    }
    case Timers.TON:
    case Timers.TOF:
    case Timers.RTO: {
      let d;
      return e[7] !== i || e[8] !== n || e[9] !== a || e[10] !== r || e[11] !== o ? (d = /* @__PURE__ */ jsx(TimerInstruction, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[7] = i, e[8] = n, e[9] = a, e[10] = r, e[11] = o, e[12] = d) : d = e[12], d;
    }
    case Counters.CTU:
    case Counters.CTD: {
      let d;
      return e[13] !== i || e[14] !== n || e[15] !== a || e[16] !== r || e[17] !== o ? (d = /* @__PURE__ */ jsx(CounterInstruction, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[13] = i, e[14] = n, e[15] = a, e[16] = r, e[17] = o, e[18] = d) : d = e[18], d;
    }
    case Resets.RES: {
      let d;
      return e[19] !== i || e[20] !== n || e[21] !== a || e[22] !== r || e[23] !== o ? (d = /* @__PURE__ */ jsx(ResetInstruction, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[19] = i, e[20] = n, e[21] = a, e[22] = r, e[23] = o, e[24] = d) : d = e[24], d;
    }
    case MoveLogical.MOV: {
      let d;
      return e[25] !== i || e[26] !== n || e[27] !== a || e[28] !== r || e[29] !== o ? (d = /* @__PURE__ */ jsx(MovInstruction, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[25] = i, e[26] = n, e[27] = a, e[28] = r, e[29] = o, e[30] = d) : d = e[30], d;
    }
    case ze.ADD:
    case ze.SUB:
    case ze.MUL:
    case ze.DIV: {
      let d;
      return e[31] !== i || e[32] !== n || e[33] !== a || e[34] !== r || e[35] !== o ? (d = /* @__PURE__ */ jsx(Um, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[31] = i, e[32] = n, e[33] = a, e[34] = r, e[35] = o, e[36] = d) : d = e[36], d;
    }
    case ge.EQ:
    case ge.NE:
    case ge.GT:
    ...
    case ge.LE: {
      let d;
      return e[37] !== i || e[38] !== n || e[39] !== a || e[40] !== r || e[41] !== o ? (d = /* @__PURE__ */ jsx(km, { type: a, instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[37] = i, e[38] = n, e[39] = a, e[40] = r, e[41] = o, e[42] = d) : d = e[42], d;
    }
    case ge.LIMIT: {
      let d;
      return e[43] !== i || e[44] !== n || e[45] !== r || e[46] !== o ? (d = /* @__PURE__ */ jsx(zm, { instructionData: n, isSelected: r, rungId: o, errorSeverity: i }), e[43] = i, e[44] = n, e[45] = r, e[46] = o, e[47] = d) : d = e[47], d;
    }
    default: {
      let d;
      return e[48] !== i || e[49] !== a || e[50] !== r || e[51] !== u ? (d = /* @__PURE__ */ jsx(Placeholder, { tag: u, type: a, isSelected: r, errorSeverity: i }), e[48] = i, e[49] = a, e[50] = r, e[51] = u, e[52] = d) : d = e[52], d;
    }
  }
}
function Hm(t) {
  if (!t) return null;
  if (t.type === LadderObjectType.INSTRUCTION)
    return {
      id: t.id,
      type: LadderObjectType.INSTRUCTION
    };
...
function Jm(t) {
  const e = MemoCache.useMemoCache(45), {
    instructionId: n,
    instructionData: r,
    rungData: o
  } = t, {
    state: s,
    actions: i
  } = useLadderEditor(), c = useLadderMenuExtras(), l = useRef(s);
  let a, u;
  e[0] !== s ? (a = () => {
    l.current = s;
  }, u = [s], e[0] = s, e[1] = a, e[2] = u) : (a = e[1], u = e[2]), useEffect(a, u);
  const {
    selectedIds: d,
    selectedType: p
  } = s.selection, h = p === LadderObjectType.INSTRUCTION && d.length > 1, v = d.length;
  let m;
  e[3] !== n || e[4] !== o ? (m = () => {
    const U = l.current, {
      selectedIds: H,
    ...
    if (K === LadderObjectType.INSTRUCTION && H.length > 1) {
      const j = [];
      for (const M of H)
        for (const G of U.rungIds) {
          const q = U.rungs[G];
          if (!q || !findIdInCircuit(M, q.circuit))
            continue;
          const Y = Fn(M, q);
          Y && j.push(In(Y));
          break;
  ...
  e[11] !== i || e[12] !== n || e[13] !== o ? (b = async () => {
    ...
    if (U.includes(";")) {
      ...
      for (let se = 0; se < H.rungIds.length; se++) {
        ...
        if (!Oe)
          continue;
        const Ge = createRungObject();
        Ge.circuit = addIdsToCircuit(Oe.circuit), i.addRung(Ge, Ie + 1 + se);
      }
      return;
    }
    ...
    if (!Z)
      return;
    const M = addIdsToCircuit(Z.circuit).elements;
    if (M.length === 0)
      return;
    const {
      parentCircuitId: G,
      index: q
    } = findParentCircuit(n, o.circuit);
    if (!G || q === null)
      return;
    let Y = {
      ...o
    ...
    for (let ie = 0; ie < M.length; ie++)
      Y = addElementToCircuit(M[ie], G, q + 1 + ie, Y);
    i.modifyRung(Y);
  ...
  e[15] !== i || e[16] !== n || e[17] !== o ? (x = () => {
    ...
    if (K === LadderObjectType.INSTRUCTION && H.length > 1) {
      ...
      for (const Y of U.rungIds) {
        const W = U.rungs[Y];
        if (W && collectInstructionIds(W.circuit).some((ae) => j.has(ae))) {
          M = rr(W.circuit, j);
          break;
        }
      }
      ...
      for (const Y of H)
        for (const W of U.rungIds) {
          const ae = G[W];
          if (!ae || !findIdInCircuit(Y, ae.circuit))
            continue;
          const {
            newRungData: ie
          } = cutElementById(Y, ae);
  ...
  }, e[15] = i, e[16] = n, e[17] = o, e[18] = x) : x = e[18];
  const C = x, O = h ? `Copy ${v} Instructions` : "Copy Instruction", N = h ? `Cut ${v} Instructions` : "Cut Instruction", E = h ? `Delete ${v} Instructions` : "Delete Instruction";
  let _;
  ...
  let y;
  e[24] !== O || e[25] !== g ? (y = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: g, shortcut: w, children: O }), e[24] = O, e[25] = g, e[26] = y) : y = e[26];
  let R;
  e[27] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (R = Pt("⌘X", "Ctrl+X"), e[27] = R) : R = e[27];
  let k;
  e[28] !== N || e[29] !== T ? (k = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: T, shortcut: R, children: N }), e[28] = N, e[29] = T, e[30] = k) : k = e[30];
  let A;
  e[31] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (A = Pt("⌘V", "Ctrl+V"), e[31] = A) : A = e[31];
  let P;
  e[32] !== S ? (P = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: S, shortcut: A, children: "Paste After" }), e[32] = S, e[33] = P) : P = e[33];
  let $;
  e[34] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? ($ = /* @__PURE__ */ jsx(ContextMenuSeparator, {}), e[34] = $) : $ = e[34];
  let X;
  e[35] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (X = Pt("⌫", "Del"), e[35] = X) : X = e[35];
  let L;
  e[36] !== E || e[37] !== C ? (L = /* @__PURE__ */ jsx(ContextMenuItem, { inset: !0, onClick: C, shortcut: X, children: E }), e[36] = E, e[37] = C, e[38] = L) : L = e[38];
  let B;
  return e[39] !== k || e[40] !== P || e[41] !== L || e[42] !== _ || e[43] !== y ? (B = /* @__PURE__ */ jsxs(dr, { "data-width-48": !0, children: [
    _,
    y,
    k,
    P,
...
function Km(t) {
  const e = MemoCache.useMemoCache(46), {
    circuitId: n,
    instructionData: r,
    index: o,
    rungData: s
  ...
  e[11] !== c || e[12] !== r.id || e[13] !== u || e[14] !== i.selection.selectedIds.length ? (T = ($) => {
    ...
    X === "replace" && u && i.selection.selectedIds.length <= 1 || c.select(r.id, LadderObjectType.INSTRUCTION, X);
  ...
  let w;
  e[21] !== r || e[22] !== u || e[23] !== s.id || e[24] !== _ ? (w = /* @__PURE__ */ jsx(fo, { instructionData: r, isSelected: u, rungId: s.id, errorSeverity: _ }), e[21] = r, e[22] = u, e[23] = s.id, e[24] = _, e[25] = w) : w = e[25];
  let y;
  e[26] !== v || e[27] !== C || e[28] !== x || e[29] !== g || e[30] !== N || e[31] !== E || e[32] !== w ? (y = /* @__PURE__ */ jsx("div", { "aria-label": N, ref: g, ...v, ...C, className: E, onMouseDown: x, children: w }), e[26] = v, e[27] = C, e[28] = x, e[29] = g, e[30] = N, e[31] = E, e[32] = w, e[33] = y) : y = e[33];
  let R;
  e[34] !== l || e[35] !== y ? (R = /* @__PURE__ */ jsx(ErrorTooltip, { errors: l, children: y }), e[34] = l, e[35] = y, e[36] = R) : R = e[36];
  let k;
  e[37] !== b || e[38] !== R ? (k = /* @__PURE__ */ jsx(ur, { className: "flex shrink-0", onContextMenu: b, children: R }), e[37] = b, e[38] = R, e[39] = k) : k = e[39];
  let A;
  e[40] !== r || e[41] !== s ? (A = /* @__PURE__ */ jsx(Jm, { instructionId: r.id, instructionData: r, rungData: s }), e[40] = r, e[41] = s, e[42] = A) : A = e[42];
  let P;
  return e[43] !== k || e[44] !== A ? (P = /* @__PURE__ */ jsxs(qr, { children: [
    k,
    A
  ] }), e[43] = k, e[44] = A, e[45] = P) : P = e[45], P;
}
function Circuit(t) {
  const e = MemoCache.useMemoCache(48), {
  ...
  let d;
  e[3] !== r ? (d = findLastNonOutputIndex(r), e[3] = r, e[4] = d) : d = e[4];
  const p = d, h = s && n;
  let v;
  e[5] !== c || e[6] !== r.id || e[7] !== s || e[8] !== a || e[9] !== i.selection.selectedIds.length ? (v = (_) => {
    if (_.stopPropagation(), a && _.button === 2)
      return;
    const w = s ? LadderObjectType.CIRCUIT : LadderObjectType.RUNG, y = _.shiftKey ? "range" : _.metaKey || _.ctrlKey ? "toggle" : "replace";
  ...
  const m = v;
  let g;
  e[11] !== h ? (g = h && /* @__PURE__ */ jsx("div", { className: "absolute bottom-[-1.875em] left-0 top-[1.875em] w-px bg-slate-400" }), e[11] = h, e[12] = g) : g = e[12];
  let I;
  e[13] !== s || e[14] !== a ? (I = a && s && /* @__PURE__ */ jsx("div", { className: "absolute -left-2 top-3 h-8 w-4 bg-selected" }), e[13] = s, e[14] = a, e[15] = I) : I = e[15];
  const T = p === -1;
  let b;
  e[16] !== r.id || e[17] !== o.id || e[18] !== T || e[19] !== u ? (b = /* @__PURE__ */ jsx(Wire, { full: T, circuitId: r.id, index: -1, wider: u, rungId: o.id }), e[16] = r.id, e[17] = o.id, e[18] = T, e[19] = u, e[20] = b) : b = e[20];
  let S;
  if (e[21] !== r.elements || e[22] !== r.id || e[23] !== p || e[24] !== o) {
    let _;
    e[26] !== r.id || e[27] !== p || e[28] !== o ? (_ = (w, y) => {
      const R = y === p;
      if (w.type === LadderObjectType.BRANCH)
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("div", { className: "flex shrink-0 flex-col", children: w.circuits.map((k, A) => /* @__PURE__ */ jsx(Circuit, { branchContinuation: A < w.circuits.length - 1, circuitData: k, isBranch: !0, rungData: o }, k.id)) }),
          /* @__PURE__ */ jsx(Wire, { full: R, circuitId: r.id, index: y, rungId: o.id })
        ] }, w.id);
      if (w.type === LadderObjectType.INSTRUCTION)
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Km, { circuitId: r.id, instructionData: w, index: y, rungData: o }),
          /* @__PURE__ */ jsx(Wire, { full: R, circuitId: r.id, index: y, rungId: o.id })
        ] }, w.id);
    }, e[26] = r.id, e[27] = p, e[28] = o, e[29] = _) : _ = e[29], S = r.elements.map(_), e[21] = r.elements, e[22] = r.id, e[23] = p, e[24] = o, e[25] = S;
  } else
    S = e[25];
  let x;
  e[30] !== h ? (x = h && /* @__PURE__ */ jsx("div", { className: "absolute bottom-[-1.875em] right-0 top-[1.875em] w-px bg-slate-400" }), e[30] = h, e[31] = x) : x = e[31];
  let C;
  e[32] !== g || e[33] !== I || e[34] !== b || e[35] !== S || e[36] !== x ? (C = /* @__PURE__ */ jsx(ur, { className: "flex min-w-full shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "relative flex min-w-full shrink-0", children: [
    g,
    I,
    b,
    S,
    x
  ] }) }), e[32] = g, e[33] = I, e[34] = b, e[35] = S, e[36] = x, e[37] = C) : C = e[37];
  let O;
  e[38] !== r.id || e[39] !== s || e[40] !== o ? (O = s ? /* @__PURE__ */ jsx(Ia, { circuitId: r.id, rungData: o }) : /* @__PURE__ */ jsx(ti, { rungData: o }), e[38] = r.id, e[39] = s, e[40] = o, e[41] = O) : O = e[41];
  let N;
  e[42] !== C || e[43] !== O ? (N = /* @__PURE__ */ jsxs(qr, { children: [
    C,
    O
  ] }), e[42] = C, e[43] = O, e[44] = N) : N = e[44];
  let E;
  return e[45] !== m || e[46] !== N ? (E = /* @__PURE__ */ jsx("div", { className: "flex min-w-full shrink-0", onMouseDown: m, onContextMenu: m, children: N }), e[45] = m, e[46] = N, e[47] = E) : E = e[47], E;
}
var Qi = {
  color: void 0,
  size: void 0,
  ...
  style: void 0,
  attr: void 0
}, os = reactDefault.createContext && /* @__PURE__ */ reactDefault.createContext(Qi), Wm = ["attr", "size", "title"];
function Xm(t, e) {
  if (t == null) return {};
  var n = Ym(t, e), r, o;
...
function ec(t) {
  return t && t.map((e, n) => /* @__PURE__ */ reactDefault.createElement(e.tag, er({
    key: n
  }, e.attr), ec(e.child)));
}
function tg(t) {
  return (e) => /* @__PURE__ */ reactDefault.createElement(ng, Qn({
    attr: er({}, t.attr)
  }, e), ec(t.child));
}
function ng(t) {
  var e = (n) => {
    ...
    return n.className && (l = n.className), t.className && (l = (l ? l + " " : "") + t.className), /* @__PURE__ */ reactDefault.createElement("svg", Qn({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, n.attr, r, i, {
      ...
      width: c,
      xmlns: "http://www.w3.org/2000/svg"
    }), s && /* @__PURE__ */ reactDefault.createElement("title", null, s), t.children);
  };
  return os !== void 0 ? /* @__PURE__ */ reactDefault.createElement(os.Consumer, null, (n) => e(n)) : e(Qi);
}
function rg(t) {
...
function og(t) {
  const e = MemoCache.useMemoCache(2), {
    ...
    errors: r
  } = useLadderEditor(), o = r.filter((u) => u.rungId === n.id), s = o.some(ig), i = o.some(sg);
  if (!s && !i)
    return null;
  const l = `h-full w-full ${s ? "text-red-600" : "text-amber-600"}`;
  let a;
  return e[0] !== l ? (a = /* @__PURE__ */ jsx("div", { className: "my-auto ml-2 flex h-5 w-5 items-center justify-center", children: /* @__PURE__ */ jsx(rg, { className: l }) }), e[0] = l, e[1] = a) : a = e[1], a;
}
function sg(t) {
...
function Rung(t) {
  const e = MemoCache.useMemoCache(54), {
    rungId: n,
    index: r
  } = t, {
    state: o,
    actions: s
  } = useLadderEditor(), i = useLadderSimulation(), c = o.rungs[n];
  let l;
  ...
  e[10] !== s || e[11] !== a || e[12] !== c || e[13] !== o.selection ? (y = (se) => {
    ...
    Oe === "replace" && a && o.selection.selectedIds.length <= 1 || s.select(c.circuit.id, LadderObjectType.RUNG, Oe);
  }, e[10] = s, e[11] = a, e[12] = c, e[13] = o.selection, e[14] = y) : y = e[14];
  const R = y;
  if (!c)
    return null;
  const k = N ? "rounded-full bg-green-400" : "bg-slate-400", P = `relative flex cursor-default ${x ? "opacity-50" : "opacity-100"} pr-2`;
  let $;
  e[15] !== w || e[16] !== k ? ($ = w && /* @__PURE__ */ jsx("div", { className: `absolute left-10 h-3 w-3 border border-slate-500 ${k}` }), e[15] = w, e[16] = k, e[17] = $) : $ = e[17];
  const X = `${a ? "bg-selected" : "bg-transparent"}`;
  let L;
  e[18] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (L = /* @__PURE__ */ jsx("div", { className: "w-2" }), e[18] = L) : L = e[18];
  const B = r >= 0 && r;
  let U;
  e[19] !== B ? (U = /* @__PURE__ */ jsx("p", { className: "text-md my-auto select-none text-black", children: B }), e[19] = B, e[20] = U) : U = e[20];
  let H;
  e[21] !== c ? (H = /* @__PURE__ */ jsx(og, { rungData: c }), e[21] = c, e[22] = H) : H = e[22];
  let K;
  e[23] !== U || e[24] !== H ? (K = /* @__PURE__ */ jsxs("div", { className: "flex h-14 w-12 flex-none", children: [
    L,
    U,
    H
  ] }), e[23] = U, e[24] = H, e[25] = K) : K = e[25];
  let Z;
  e[26] !== T || e[27] !== b || e[28] !== S || e[29] !== X || e[30] !== K ? (Z = /* @__PURE__ */ jsx(ur, { className: "flex h-full", children: /* @__PURE__ */ jsx("div", { ref: S, ...T, ...b, className: X, children: K }) }), e[26] = T, e[27] = b, e[28] = S, e[29] = X, e[30] = K, e[31] = Z) : Z = e[31];
  let j;
  e[32] !== c ? (j = /* @__PURE__ */ jsx(ti, { rungData: c }), e[32] = c, e[33] = j) : j = e[33];
  let M;
  e[34] !== Z || e[35] !== j ? (M = /* @__PURE__ */ jsxs(qr, { children: [
    Z,
    j
  ] }), e[34] = Z, e[35] = j, e[36] = M) : M = e[36];
  let G;
  e[37] !== R || e[38] !== M ? (G = /* @__PURE__ */ jsx("div", { onMouseDown: R, onContextMenu: R, children: M }), e[37] = R, e[38] = M, e[39] = G) : G = e[39];
  const q = `relative flex w-full overflow-visible border-l ${d} ${p}`;
  let Y;
  e[40] !== c ? (Y = /* @__PURE__ */ jsx(Circuit, { circuitData: c.circuit, rungData: c }), e[40] = c, e[41] = Y) : Y = e[41];
  const W = `relative overflow-visible border-l ${d} pr-1 ${p}`;
  let ae;
  e[42] !== W ? (ae = /* @__PURE__ */ jsx("div", { className: W }), e[42] = W, e[43] = ae) : ae = e[43];
  let ie;
  e[44] !== q || e[45] !== Y || e[46] !== ae ? (ie = /* @__PURE__ */ jsxs("div", { className: q, children: [
    Y,
    ae
  ] }), e[44] = q, e[45] = Y, e[46] = ae, e[47] = ie) : ie = e[47];
  let Ie;
  return e[48] !== O || e[49] !== G || e[50] !== ie || e[51] !== P || e[52] !== $ ? (Ie = /* @__PURE__ */ jsxs("div", { ref: O, className: P, children: [
    $,
    G,
    ie
...
function is(t) {
  ...
  for (const r of e)
    for (const o of t.rungIds) {
      const s = t.rungs[o];
      if (!s || !findIdInCircuit(r, s.circuit)) continue;
      const i = Fn(r, s);
      i && n.push(In(i));
      break;
    }
...
function ag(t, e, n) {
  const r = t.rungIds.map((o) => t.rungs[o]).filter(Boolean).map((o) => {
    const s = createRungObject();
    return s.circuit = addIdsToCircuit(o.circuit), s;
  });
...
function LadderDiagram() {
  const t = MemoCache.useMemoCache(50), {
    state: e,
    actions: n
  } = useLadderEditor(), r = useRef(null);
  let o;
  ...
  let s;
  t[2] !== e.selection.selectedIds ? (s = [e.selection.selectedIds], t[2] = e.selection.selectedIds, t[3] = s) : s = t[3], useEffect(o, s);
  const i = fg;
  let c;
  t[4] !== e ? (c = (_) => {
    _.preventDefault();
    ...
    let y = "";
    w === LadderObjectType.INSTRUCTION ? y = is(e) : w === LadderObjectType.RUNG ? y = cs(e) : w === LadderObjectType.CIRCUIT && (y = ls(e)), y && navigator.clipboard.writeText(y);
  }, t[4] = e, t[5] = c) : c = t[5];
  const l = c;
  let a;
  ...
  t[11] !== n || t[12] !== e.rungIds || t[13] !== e.rungs || t[14] !== e.selection ? (d = () => {
    ...
    for (const k of _)
      for (const A of e.rungIds) {
        const P = w[A];
        if (!P || !findIdInCircuit(k, P.circuit))
          continue;
        y || (y = P.circuit.id);
        const {
          newRungData: $
  ...
  t[16] !== n || t[17] !== e.rungIds || t[18] !== e.rungs || t[19] !== e.selection ? (h = () => {
    ...
    for (const A of e.rungIds) {
      const P = e.rungs[A];
      if (P && collectInstructionIds(P.circuit).some(($) => w.has($))) {
        y = rr(P.circuit, w);
        break;
      }
    }
  ...
  t[21] !== p || t[22] !== v || t[23] !== u || t[24] !== e ? (m = (_) => {
    ...
    if (w.length !== 0) {
      if (y === LadderObjectType.INSTRUCTION) {
        const R = is(e);
        R && navigator.clipboard.writeText(R), v();
      } else if (y === LadderObjectType.RUNG) {
        const R = cs(e);
        R && navigator.clipboard.writeText(R), u();
      } else if (y === LadderObjectType.CIRCUIT) {
        const R = ls(e);
  ...
  t[26] !== p || t[27] !== v || t[28] !== u || t[29] !== e.selection ? (I = (_) => {
    ...
    w.length !== 0 && (y === LadderObjectType.INSTRUCTION ? v() : y === LadderObjectType.RUNG ? u() : y === LadderObjectType.CIRCUIT && p());
  ...
  t[31] !== n || t[32] !== e.rungIds || t[33] !== e.rungs || t[34] !== e.selection ? (b = async (_) => {
    ...
    if (!A && R) {
      ...
      if (!$)
        return;
      const L = addIdsToCircuit($.circuit).elements;
      if (L.length === 0)
        return;
      const B = findRungIndexById(R, P);
      if (B === -1)
        return;
      const U = P[B];
      let H, K;
      if (k === LadderObjectType.INSTRUCTION) {
        const {
          parentCircuitId: G,
          index: q
        } = findParentCircuit(R, U.circuit);
        if (!G || q === null)
          return;
        H = G, K = q + 1;
      } else {
      ...
      for (let G = 0; G < L.length; G++)
        Z = addElementToCircuit(L[G], H, K + G, Z);
      n.modifyRung(Z);
  ...
  const S = b;
  let x;
  t[36] !== n || t[37] !== l || t[38] !== g || t[39] !== T || t[40] !== S ? (x = (_) => {
    if (ug(_.target))
      return;
    const w = _.metaKey || _.ctrlKey, y = _.key.toLowerCase(), R = w && y === "LadderObjectType" && !_.shiftKey, k = w && y === "LadderObjectType" && _.shiftKey, A = _.ctrlKey && !_.metaKey && y === "y";
    R ? (_.preventDefault(), n.undo()) : k || A ? (_.preventDefault(), n.redo()) : w && y === "a" ? (_.preventDefault(), n.selectAll()) : w && y === "c" ? l(_) : w && y === "x" ? g(_) : w && y === "v" ? S(_) : (y === "delete" || y === "backspace") && T(_);
  }, t[36] = n, t[37] = l, t[38] = g, t[39] = T, t[40] = S, t[41] = x) : x = t[41];
  const C = x;
  let O;
  t[42] !== e.rungIds ? (O = e.rungIds.map(dg), t[42] = e.rungIds, t[43] = O) : O = t[43];
  let N;
  t[44] !== e.rungIds.length ? (N = /* @__PURE__ */ jsx(EndRung, { index: e.rungIds.length }), t[44] = e.rungIds.length, t[45] = N) : N = t[45];
  let E;
  return t[46] !== C || t[47] !== O || t[48] !== N ? (E = /* @__PURE__ */ jsxs("div", { ref: r, className: "h-full select-none overflow-auto bg-white pt-2 focus:outline-hidden", tabIndex: 0, onContextMenu: i, onKeyDown: C, children: [
    O,
    N
  ] }), t[46] = C, t[47] = O, t[48] = N, t[49] = E) : E = t[49], E;
}
function dg(t, e) {
  return /* @__PURE__ */ jsx(Rung, { rungId: t, index: e }, t);
}
function fg(t) {
  t.preventDefault();
}
function kr(t) {
  const e = MemoCache.useMemoCache(3), {
    full: n
  } = t, o = `flex h-15 min-w-4 flex-col justify-center ${n ? "w-full" : "w-4"}`;
  let s;
  e[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (s = /* @__PURE__ */ jsx("div", { className: "h-px w-full bg-slate-400" }), e[0] = s) : s = e[0];
  let i;
  return e[1] !== o ? (i = /* @__PURE__ */ jsx("div", { className: o, children: s }), e[1] = o, e[2] = i) : i = e[2], i;
}
function tc(t) {
  const e = MemoCache.useMemoCache(20), {
    circuitData: n,
  ...
  let i;
  e[0] !== n ? (i = findLastNonOutputIndex(n), e[0] = n, e[1] = i) : i = e[1];
  const c = i, l = o && s;
  let a;
  e[2] !== l ? (a = l && /* @__PURE__ */ jsx("div", { className: "absolute bottom-[-1.875em] left-0 top-[1.875em] w-px bg-slate-400" }), e[2] = l, e[3] = a) : a = e[3];
  const u = c === -1;
  let d;
  e[4] !== u ? (d = /* @__PURE__ */ jsx(kr, { full: u }), e[4] = u, e[5] = d) : d = e[5];
  let p;
  if (e[6] !== n.elements || e[7] !== c || e[8] !== r) {
    let m;
    e[10] !== c || e[11] !== r ? (m = (g, I) => {
      const T = I === c;
      return g.type === LadderObjectType.BRANCH ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("div", { className: "flex shrink-0 flex-col", children: g.circuits.map((b, S) => /* @__PURE__ */ jsx(tc, { branchContinuation: S < g.circuits.length - 1, circuitData: b, isBranch: !0, rungData: r }, b.id)) }),
        /* @__PURE__ */ jsx(kr, { full: T })
      ] }, g.id) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("div", { className: "flex shrink-0", children: /* @__PURE__ */ jsx(fo, { instructionData: g, isSelected: !1, rungId: r.id }) }),
        /* @__PURE__ */ jsx(kr, { full: T })
      ] }, g.id);
    ...
    p = e[9];
  let h;
  e[13] !== l ? (h = l && /* @__PURE__ */ jsx("div", { className: "absolute bottom-[-1.875em] right-0 top-[1.875em] w-px bg-slate-400" }), e[13] = l, e[14] = h) : h = e[14];
  let v;
  return e[15] !== a || e[16] !== d || e[17] !== p || e[18] !== h ? (v = /* @__PURE__ */ jsx("div", { className: "flex min-w-full shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "relative flex min-w-full shrink-0", children: [
    a,
    d,
    p,
    h
...
function pg(t) {
  ...
  let o;
  e[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (o = /* @__PURE__ */ jsx("div", { className: "w-2" }), e[0] = o) : o = e[0];
  let s;
  e[1] !== r ? (s = /* @__PURE__ */ jsxs("div", { className: "flex h-14 w-12 flex-none items-center", children: [
    o,
    /* @__PURE__ */ jsx("p", { className: "text-md text-black", children: r })
  ] }), e[1] = r, e[2] = s) : s = e[2];
  let i;
  e[3] !== n ? (i = /* @__PURE__ */ jsx(tc, { circuitData: n.circuit, rungData: n }), e[3] = n, e[4] = i) : i = e[4];
  let c;
  e[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (c = /* @__PURE__ */ jsx("div", { className: "relative overflow-visible border-l border-slate-400 pr-1" }), e[5] = c) : c = e[5];
  let l;
  e[6] !== i ? (l = /* @__PURE__ */ jsxs("div", { className: "relative flex w-full overflow-visible border-l border-slate-400", children: [
    i,
    c
  ] }), e[6] = i, e[7] = l) : l = e[7];
  let a;
  return e[8] !== s || e[9] !== l ? (a = /* @__PURE__ */ jsxs("div", { className: "flex pr-2", children: [
    s,
    l
...
function Zn(t) {
  ...
  if (n === Contacts.ONS) {
    let h;
    return e[0] !== i ? (h = /* @__PURE__ */ jsx("div", { className: "flex h-4 items-center", children: /* @__PURE__ */ jsx(si, { textColor: i }) }), e[0] = i, e[1] = h) : h = e[1], h;
  }
  const c = `my-auto -mr-0.5 h-px w-1.5 ${s}`;
  let l;
  e[2] !== c ? (l = /* @__PURE__ */ jsx("div", { className: c }), e[2] = c, e[3] = l) : l = e[3];
  let a;
  e[4] !== o || e[5] !== i || e[6] !== n ? (a = /* @__PURE__ */ jsx(oi, { type: n, borderColor: o, textColor: i }), e[4] = o, e[5] = i, e[6] = n, e[7] = a) : a = e[7];
  const u = `my-auto -ml-0.5 h-px w-1.5 ${s}`;
  let d;
  e[8] !== u ? (d = /* @__PURE__ */ jsx("div", { className: u }), e[8] = u, e[9] = d) : d = e[9];
  let p;
  return e[10] !== l || e[11] !== a || e[12] !== d ? (p = /* @__PURE__ */ jsxs("div", { className: "flex h-4", children: [
    l,
    a,
    d
...
function Bn(t) {
  const e = MemoCache.useMemoCache(12), {
    type: n,
    isEnabled: r
  ...
  const a = hg[n];
  let u;
  e[2] !== o || e[3] !== a || e[4] !== i ? (u = /* @__PURE__ */ jsx(fr, { label: a, borderColor: o, textColor: i }), e[2] = o, e[3] = a, e[4] = i, e[5] = u) : u = e[5];
  const d = `my-auto h-px w-1.5 ${s}`;
  let p;
  e[6] !== d ? (p = /* @__PURE__ */ jsx("div", { className: d }), e[6] = d, e[7] = p) : p = e[7];
  let h;
  return e[8] !== l || e[9] !== u || e[10] !== p ? (h = /* @__PURE__ */ jsxs("div", { className: "flex h-4", children: [
    l,
    u,
    p
...
function nc(t) {
  ...
  let i;
  return e[0] !== n || e[1] !== s ? (i = /* @__PURE__ */ jsx("div", { className: "flex min-w-8 items-center justify-center px-1 py-0.5", children: /* @__PURE__ */ jsx("span", { className: s, children: n }) }), e[0] = n, e[1] = s, e[2] = i) : i = e[2], i;
}
function rc(t) {
  const e = MemoCache.useMemoCache(11), {
    isEnabled: n
  ...
  let c;
  e[0] !== i ? (c = /* @__PURE__ */ jsx("div", { className: i }), e[0] = i, e[1] = c) : c = e[1];
  let l;
  e[2] !== r || e[3] !== s ? (l = /* @__PURE__ */ jsx(fr, { label: "RES", centerClassName: "min-w-5", borderColor: r, textColor: s }), e[2] = r, e[3] = s, e[4] = l) : l = e[4];
  const a = `my-auto h-px w-1.5 ${o}`;
  let u;
  e[5] !== a ? (u = /* @__PURE__ */ jsx("div", { className: a }), e[5] = a, e[6] = u) : u = e[6];
  let d;
  return e[7] !== c || e[8] !== l || e[9] !== u ? (d = /* @__PURE__ */ jsxs("div", { className: "flex h-4", children: [
    c,
    l,
    u
  ] }), e[7] = c, e[8] = l, e[9] = u, e[10] = d) : d = e[10], d;
}
function LadderDndProvider(t) {
  const e = MemoCache.useMemoCache(26), {
    children: children
  } = t, {
    state: editorState,
    actions: editorActions
  } = useLadderEditor(), [s, i] = useState(null);
  let c;
  e[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (c = {
  ...
  let u;
  e[2] !== editorActions || e[3] !== editorState.rungs ? (u = (N, E) => {
    const {
      circuitId: _,
      rungId: w,
      index: y
    ...
    if (!(!_ || !w))
      e: switch (N.type) {
        case "INSTRUCTION": {
          ...
          editorActions.moveInstruction(R.instructionData.id, R.rungId, _, w, P);
          break e;
        }
        case "TOOL_INSTRUCTION": {
          const R = N, k = y + 1, A = editorState.rungs[w];
          if (!A)
            return;
          const P = createInstructionObject(R.instructionType), $ = addElementToCircuit(P, _, k, A);
          editorActions.modifyRung($), editorActions.select(P.id, LadderObjectType.INSTRUCTION);
          break e;
        }
        case "TOOL_BRANCH": {
          const R = y + 1;
          editorActions.addBranch(createBranchObject(), _, R, w);
        }
      }
  }, e[2] = editorActions, e[3] = editorState.rungs, e[4] = u) : u = e[4];
  const d = u;
  let p;
  e[5] !== editorActions ? (p = (N, E) => {
    const {
      index: _
    } = E;
    e: switch (N.type) {
      case "RUNG": {
        ...
        editorActions.moveRung(w.index, y);
        break e;
      }
      case "TOOL_RUNG": {
        const w = createRungObject();
        editorActions.addRung(w, _);
      }
    }
  }, e[5] = editorActions, e[6] = p) : p = e[6];
  const h = p;
  let v;
  ...
  e[11] !== s ? (T = () => {
    ...
    switch (s.type) {
      ...
      case "INSTRUCTION": {
        const E = s;
        return /* @__PURE__ */ jsx(fo, { instructionData: E.instructionData, isSelected: !1, rungId: E.rungId });
      }
      case "RUNG": {
        const E = s;
        return /* @__PURE__ */ jsx(pg, { rungData: E.rungData, index: E.index });
      }
      case "TOOL_RUNG":
        return /* @__PURE__ */ jsx("div", { className: "flex h-6 w-8 border-x-2 border-blue-600", children: /* @__PURE__ */ jsx("div", { className: "my-auto h-0.5 w-full bg-blue-600" }) });
      case "TOOL_BRANCH":
        return /* @__PURE__ */ jsx("div", { className: "flex h-6 w-8 border-x border-slate-700", children: /* @__PURE__ */ jsx("div", { className: "my-auto h-px w-full bg-blue-600", children: /* @__PURE__ */ jsx("div", { className: "m-auto mt-px flex h-2.5 w-5 border-x-2 border-b-2 border-blue-600" }) }) });
      default:
        return null;
    }
  ...
  const b = T;
  let S;
  e[13] !== s ? (S = s && /* @__PURE__ */ jsx("style", { children: "* { cursor: default; }" }), e[13] = s, e[14] = S) : S = e[14];
  let x;
  e[15] !== s || e[16] !== b ? (x = s ? /* @__PURE__ */ jsx("div", { style: {
    opacity: 0.5
  }, children: b() }) : null, e[15] = s, e[16] = b, e[17] = x) : x = e[17];
  let C;
  e[18] !== x ? (C = /* @__PURE__ */ jsx(ya, { dropAnimation: null, children: x }), e[18] = x, e[19] = C) : C = e[19];
  let O;
  return e[20] !== children || e[21] !== I || e[22] !== a || e[23] !== C || e[24] !== S ? (O = /* @__PURE__ */ jsxs(ea, { sensors: a, collisionDetection: ul, onDragStart: m, onDragEnd: I, autoScroll: !1, children: [
    S,
    children,
    C
  ] }), e[20] = children, e[21] = I, e[22] = a, e[23] = C, e[24] = S, e[25] = O) : O = e[25], O;
}
function mg(t) {
  return t === Contacts.XIC || t === Contacts.XIO || t === Contacts.ONS ? /* @__PURE__ */ jsx(Zn, { type: t, isEnabled: !0 }) : t === Coils.OTE || t === Coils.OTL || t === Coils.OTU ? /* @__PURE__ */ jsx(Bn, { type: t, isEnabled: !0 }) : t === Resets.RES ? /* @__PURE__ */ jsx(rc, { isEnabled: !0 }) : /* @__PURE__ */ jsx(nc, { label: t, isEnabled: !0 });
}
function as() {
  const t = MemoCache.useMemoCache(32), {
    state: e,
    actions: n
  } = useLadderEditor();
  let r;
  ...
  t[8] !== n || t[9] !== o || t[10] !== e.rungIds[0] || t[11] !== e.rungIds.length || t[12] !== e.selection ? (T = function() {
    if (e.rungIds.length === 0)
      return;
    const k = e.selection.selectedIds.at(-1) || e.rungIds[0], A = k ? findRungIndexById(k, o) : 0, P = A < 0 ? 0 : A, $ = o[P];
    if (!$)
      return;
    const X = $.circuit, L = X.id, {
      parentCircuitId: B,
      index: U
    } = findParentCircuit(k, X), H = B || L, K = U === null ? 0 : U + 1;
    n.addBranch(createBranchObject(), H, K, $.id);
  }, t[8] = n, t[9] = o, t[10] = e.rungIds[0], t[11] = e.rungIds.length, t[12] = e.selection, t[13] = T) : T = t[13];
  const b = T;
  let S;
  t[14] !== b || t[15] !== s ? (S = () => s && b(), t[14] = b, t[15] = s, t[16] = S) : S = t[16];
  const x = `my-1 cursor-default p-1 text-xl text-black focus:outline-hidden ${I} ${h ? "opacity-50" : ""}`, C = `flex h-6 w-8 border-x ${v}`, O = `my-auto h-px w-full ${g}`, N = `m-auto mt-px flex h-2.5 w-5 border-x-2 border-b-2 ${m}`;
  let E;
  t[17] !== N ? (E = /* @__PURE__ */ jsx("div", { className: N }), t[17] = N, t[18] = E) : E = t[18];
  let _;
  t[19] !== E || t[20] !== O ? (_ = /* @__PURE__ */ jsx("div", { className: O, children: E }), t[19] = E, t[20] = O, t[21] = _) : _ = t[21];
  let w;
  t[22] !== _ || t[23] !== C ? (w = /* @__PURE__ */ jsx("div", { className: C, children: _ }), t[22] = _, t[23] = C, t[24] = w) : w = t[24];
  let y;
  return t[25] !== u || t[26] !== d || t[27] !== p || t[28] !== w || t[29] !== S || t[30] !== x ? (y = /* @__PURE__ */ jsx("button", { "aria-label": "Add branch", onClick: S, ref: p, ...u, ...d, className: x, children: w }), t[25] = u, t[26] = d, t[27] = p, t[28] = w, t[29] = S, t[30] = x, t[31] = y) : y = t[31], y;
}
function BranchLevelTool() {
  const t = MemoCache.useMemoCache(38), {
    state: e,
    actions: n
  } = useLadderEditor();
  let r;
  if (t[0] !== e.rungIds || t[1] !== e.rungs) {
    ...
    r = t[2];
  const o = r, s = e.selection.selectedType === LadderObjectType.CIRCUIT, i = s ? "arrowhead-active" : "arrowhead-disabled", c = s ? "#2d65e5" : "#a0aec0", l = s ? "border-slate-700" : "border-slate-400", a = s ? "bg-slate-700" : "bg-slate-400", u = s ? "hover:bg-blue-200" : "";
  let d;
  t[5] !== n || t[6] !== o || t[7] !== e.selection.selectedIds || t[8] !== e.selection.selectedType ? (d = function() {
    const k = e.selection.selectedIds.at(-1) ?? null;
    if (e.selection.selectedType !== LadderObjectType.CIRCUIT || !k)
      return;
    const A = createCircuitObject(), P = findRungIndexById(k, o);
    if (P < 0)
      return;
    const $ = o[P];
  ...
  let b;
  t[13] !== T ? (b = /* @__PURE__ */ jsx("polygon", { fill: T, points: "0 0, 2 1.5, 0 3" }), t[13] = T, t[14] = b) : b = t[14];
  let S;
  t[15] !== i || t[16] !== b ? (S = /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("marker", { id: i, markerWidth: "2", markerHeight: "3", refX: "0", refY: "1.5", orient: "auto-start-reverse", children: b }) }), t[15] = i, t[16] = b, t[17] = S) : S = t[17];
  const x = `url(#${i})`, C = `url(#${i})`;
  let O;
  t[18] !== c || t[19] !== x || t[20] !== C ? (O = /* @__PURE__ */ jsx("line", { x1: "4", y1: "5", x2: "16", y2: "5", stroke: c, strokeWidth: "2", markerStart: x, markerEnd: C }), t[18] = c, t[19] = x, t[20] = C, t[21] = O) : O = t[21];
  let N;
  t[22] !== O || t[23] !== S ? (N = /* @__PURE__ */ jsxs("svg", { width: "20", height: "10", viewBox: "0 0 20 10", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    S,
    O
  ] }), t[22] = O, t[23] = S, t[24] = N) : N = t[24];
  let E;
  t[25] !== N || t[26] !== I ? (E = /* @__PURE__ */ jsx("div", { className: I, children: N }), t[25] = N, t[26] = I, t[27] = E) : E = t[27];
  let _;
  t[28] !== E || t[29] !== g ? (_ = /* @__PURE__ */ jsx("div", { className: g, children: E }), t[28] = E, t[29] = g, t[30] = _) : _ = t[30];
  let w;
  t[31] !== _ || t[32] !== m ? (w = /* @__PURE__ */ jsx("div", { className: m, children: _ }), t[31] = _, t[32] = m, t[33] = w) : w = t[33];
  let y;
  return t[34] !== w || t[35] !== h || t[36] !== v ? (y = /* @__PURE__ */ jsx("button", { "aria-label": "Add branch level", onClick: h, className: v, children: w }), t[34] = w, t[35] = h, t[36] = v, t[37] = y) : y = t[37], y;
}
function gg(t) {
  return !!t;
}
function InstructionTool(t) {
  const e = MemoCache.useMemoCache(34), {
    type: n
  } = t, {
    state: r,
    actions: o
  ...
  e[5] !== n ? (l = (w) => {
    switch (n) {
      case Contacts.XIO:
        return /* @__PURE__ */ jsx(Zn, { type: Contacts.XIO, isEnabled: w });
      case Contacts.XIC:
        return /* @__PURE__ */ jsx(Zn, { type: Contacts.XIC, isEnabled: w });
      case Contacts.ONS:
        return /* @__PURE__ */ jsx(Zn, { type: Contacts.ONS, isEnabled: w });
      case Coils.OTE:
        return /* @__PURE__ */ jsx(Bn, { type: Coils.OTE, isEnabled: w });
      case Coils.OTL:
        return /* @__PURE__ */ jsx(Bn, { type: Coils.OTL, isEnabled: w });
      case Coils.OTU:
        return /* @__PURE__ */ jsx(Bn, { type: Coils.OTU, isEnabled: w });
      case Resets.RES:
        return /* @__PURE__ */ jsx(rc, { isEnabled: w });
      case Timers.TON:
      case Timers.TOF:
      case Timers.RTO:
      case Counters.CTU:
      ...
      case ge.LT:
      case ge.LE:
        return /* @__PURE__ */ jsx(nc, { label: n, isEnabled: w });
      default:
        return null;
    }
  }, e[5] = n, e[6] = l) : l = e[6];
  ...
  let S;
  e[13] !== o || e[14] !== i || e[15] !== r.rungIds[0] || e[16] !== r.rungIds.length || e[17] !== r.selection || e[18] !== n ? (S = function() {
    if (r.rungIds.length === 0)
      return;
    const y = r.selection.selectedIds.at(-1) || r.rungIds[0], R = createInstructionObject(n), k = y ? findRungIndexById(y, i) : 0, A = k < 0 ? 0 : k, P = i[A];
    if (!P)
      return;
    const $ = P.circuit, {
      parentCircuitId: X,
      index: L
    } = findParentCircuit(y, $), B = L === null ? 0 : L + 1, U = $.id, K = addElementToCircuit(R, X || U, B, P);
    o.modifyRung(K), o.select(R.id, LadderObjectType.INSTRUCTION);
  }, e[13] = o, e[14] = i, e[15] = r.rungIds[0], e[16] = r.rungIds.length, e[17] = r.selection, e[18] = n, e[19] = S) : S = e[19];
  const x = S, C = `Add instruction ${n}`;
  let O;
  e[20] !== x || e[21] !== c ? (O = () => c && x(), e[20] = x, e[21] = c, e[22] = O) : O = e[22];
  ...
  let _;
  return e[26] !== g || e[27] !== I || e[28] !== T || e[29] !== N || e[30] !== E || e[31] !== C || e[32] !== O ? (_ = /* @__PURE__ */ jsx("button", { "aria-label": C, onClick: O, ref: T, ...g, ...I, className: N, children: E }), e[26] = g, e[27] = I, e[28] = T, e[29] = N, e[30] = E, e[31] = C, e[32] = O, e[33] = _) : _ = e[33], _;
}
function RungTool() {
  const t = MemoCache.useMemoCache(21), {
    state: e,
    actions: n
  } = useLadderEditor();
  let r;
  if (t[0] !== e.rungIds || t[1] !== e.rungs) {
    let x;
    t[3] !== e.rungs ? (x = (C) => e.rungs[C], t[3] = e.rungs, t[4] = x) : x = t[4], r = e.rungIds.map(x), t[0] = e.rungIds, t[1] = e.rungs, t[2] = r;
  } else
    r = t[2];
  const o = r;
  let s;
  ...
  t[7] !== n || t[8] !== o || t[9] !== e.rungIds.length || t[10] !== e.selection.selectedIds ? (m = function() {
    const C = createRungObject(), O = e.selection.selectedIds.at(-1) ?? null, N = O ? findRungIndexById(O, o) : e.rungIds.length;
    n.addRung(C, N + 1);
  ...
  let b;
  t[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (b = /* @__PURE__ */ jsx("div", { className: `flex h-6 w-8 border-x-2 ${p}`, children: /* @__PURE__ */ jsx("div", { className: `my-auto h-0.5 w-full ${h}` }) }), t[14] = b) : b = t[14];
  let S;
  return t[15] !== l || t[16] !== a || t[17] !== u || t[18] !== I || t[19] !== T ? (S = /* @__PURE__ */ jsx("button", { "aria-label": "Add rung", onClick: I, ref: u, ...l, ...a, className: T, children: b }), t[15] = l, t[16] = a, t[17] = u, t[18] = I, t[19] = T, t[20] = S) : S = t[20], S;
}
...
function LadderToolbar(t) {
  const e = MemoCache.useMemoCache(58), {
    className: n,
    orientation: r
  } = t, o = r === void 0 ? "horizontal" : r, [s, i] = useState("bit"), c = o === "horizontal", l = c ? "flex-row" : "flex-col items-center", a = bg, u = yg;
  if (!c) {
    let N;
    e[0] !== n || e[1] !== l ? (N = $r("flex gap-2", l, n), e[0] = n, e[1] = l, e[2] = N) : N = e[2];
    let E, _, w, y, R, k, A, P, $, X, L, B, U, H, K, Z, j, M, G, q, Y, W, ae, ie, Ie, se;
    e[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (q = /* @__PURE__ */ jsx(RungTool, {}), Y = /* @__PURE__ */ jsx(as, {}), W = /* @__PURE__ */ jsx(BranchLevelTool, {}), ae = /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.XIC }), ie = /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.XIO }), Ie = /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.ONS }), se = /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTE }), E = /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTL }), _ = /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTU }), w = /* @__PURE__ */ jsx(InstructionTool, { type: Resets.RES }), y = /* @__PURE__ */ jsx(InstructionTool, { type: Timers.TON }), R = /* @__PURE__ */ jsx(InstructionTool, { type: Timers.TOF }), k = /* @__PURE__ */ jsx(InstructionTool, { type: Timers.RTO }), A = /* @__PURE__ */ jsx(InstructionTool, { type: Counters.CTU }), P = /* @__PURE__ */ jsx(InstructionTool, { type: Counters.CTD }), $ = /* @__PURE__ */ jsx(InstructionTool, { type: MoveLogical.MOV }), X = /* @__PURE__ */ jsx(InstructionTool, { type: ze.ADD }), L = /* @__PURE__ */ jsx(InstructionTool, { type: ze.SUB }), B = /* @__PURE__ */ jsx(InstructionTool, { type: ze.MUL }), U = /* @__PURE__ */ jsx(InstructionTool, { type: ze.DIV }), H = /* @__PURE__ */ jsx(InstructionTool, { type: ge.EQ }), K = /* @__PURE__ */ jsx(InstructionTool, { type: ge.NE }), Z = /* @__PURE__ */ jsx(InstructionTool, { type: ge.GT }), j = /* @__PURE__ */ jsx(InstructionTool, { type: ge.GE }), M = /* @__PURE__ */ jsx(InstructionTool, { type: ge.LT }), G = /* @__PURE__ */ jsx(InstructionTool, { type: ge.LE }), e[3] = E, e[4] = _, e[5] = w, e[6] = y, e[7] = R, e[8] = k, e[9] = A, e[10] = P, e[11] = $, e[12] = X, e[13] = L, e[14] = B, e[15] = U, e[16] = H, e[17] = K, e[18] = Z, e[19] = j, e[20] = M, e[21] = G, e[22] = q, e[23] = Y, e[24] = W, e[25] = ae, e[26] = ie, e[27] = Ie, e[28] = se) : (E = e[3], _ = e[4], w = e[5], y = e[6], R = e[7], k = e[8], A = e[9], P = e[10], $ = e[11], X = e[12], L = e[13], B = e[14], U = e[15], H = e[16], K = e[17], Z = e[18], j = e[19], M = e[20], G = e[21], q = e[22], Y = e[23], W = e[24], ae = e[25], ie = e[26], Ie = e[27], se = e[28]);
    let Oe;
    return e[29] !== N ? (Oe = /* @__PURE__ */ jsxs("div", { className: N, onContextMenu: a, onMouseDown: u, children: [
      q,
      Y,
      W,
      ae,
  ...
  let p, h, v;
  e[33] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (p = /* @__PURE__ */ jsx(RungTool, {}), h = /* @__PURE__ */ jsx(as, {}), v = /* @__PURE__ */ jsx(BranchLevelTool, {}), e[33] = p, e[34] = h, e[35] = v) : (p = e[33], h = e[34], v = e[35]);
  let m;
  e[36] !== s ? (m = s === "bit" && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.XIC }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.XIO }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Contacts.ONS }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTE }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTL }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Coils.OTU })
  ] }), e[36] = s, e[37] = m) : m = e[37];
  let g;
  e[38] !== s ? (g = s === "timer-counter" && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(InstructionTool, { type: Timers.TON }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Timers.TOF }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Timers.RTO }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Counters.CTU }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Counters.CTD }),
    /* @__PURE__ */ jsx(InstructionTool, { type: Resets.RES })
  ] }), e[38] = s, e[39] = g) : g = e[39];
  let I;
  e[40] !== s ? (I = s === "math" && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(InstructionTool, { type: MoveLogical.MOV }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ze.ADD }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ze.SUB }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ze.MUL }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ze.DIV })
  ] }), e[40] = s, e[41] = I) : I = e[41];
  let T;
  e[42] !== s ? (T = s === "compare" && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.EQ }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.NE }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.GT }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.GE }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.LT }),
    /* @__PURE__ */ jsx(InstructionTool, { type: ge.LE })
  ] }), e[42] = s, e[43] = T) : T = e[43];
  let b;
  e[44] !== m || e[45] !== g || e[46] !== I || e[47] !== T ? (b = /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center gap-2 pl-2", children: [
    p,
    h,
    v,
    m,
  ...
  let S;
  e[49] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (S = {
    paddingLeft: "9.5rem"
  }, e[49] = S) : S = e[49];
  let x;
  e[50] !== s ? (x = vg.map((N) => /* @__PURE__ */ jsx("button", { type: "button", className: $r("cursor-default px-3 py-1 text-xs font-medium transition-colors focus:outline-hidden", s === N.id ? "bg-slate-300 text-slate-900" : "text-slate-600 hover:bg-slate-200"), onClick: () => i(N.id), children: N.label }, N.id)), e[50] = s, e[51] = x) : x = e[51];
  let C;
  e[52] !== x ? (C = /* @__PURE__ */ jsx("div", { className: "flex border-y bg-slate-100", style: S, children: x }), e[52] = x, e[53] = C) : C = e[53];
  let O;
  return e[54] !== b || e[55] !== C || e[56] !== d ? (O = /* @__PURE__ */ jsxs("div", { className: d, onContextMenu: a, onMouseDown: u, children: [
    b,
    C
...
export {
  BasicInstruction as BasicInstruction,
  BasicTagName as BasicTagName,
  BranchLevelTool as BranchLevelTool,
  as as BranchTool,
  Circuit as Circuit,
  Coils as Coils,
  ...
  CounterInstruction as CounterInstruction,
  Counters as Counters,
  EndRung as EndRung,
  ErrorTooltip as ErrorTooltip,
  INPUTS as INPUTS,
  InstructionTool as InstructionTool,
  LadderDiagram as LadderDiagram,
  LadderDndProvider as LadderDndProvider,
  LadderEditorContext as LadderEditorContext,
  LadderEditorProvider as LadderEditorProvider,
  LadderMenuExtrasContext as LadderMenuExtrasContext,
  LadderObjectType as LadderObjectType,
  LadderSimulationContext as LadderSimulationContext,
  LadderTagCatalogContext as LadderTagCatalogContext,
  LadderToolbar as LadderToolbar,
  MovInstruction as MovInstruction,
  MoveLogical as MoveLogical,
  OUTPUTS as OUTPUTS,
  Placeholder as Placeholder,
  ResetInstruction as ResetInstruction,
  Resets as Resets,
  Rung as Rung,
  RungTool as RungTool,
  TimerInstruction as TimerInstruction,
  Timers as Timers,
  Wire as Wire,
  addBranchLevelToCircuit as addBranchLevelToCircuit,
  addElementToCircuit as addElementToCircuit,
  addIdsToCircuit as addIdsToCircuit,
  collectInstructionIds as collectInstructionIds,
  createBranchObject as createBranchObject,
  createCircuitObject as createCircuitObject,
  createInstructionObject as createInstructionObject,
  createRungObject as createRungObject,
  cutElementById as cutElementById,
  findIdInCircuit as findIdInCircuit,
  findLastNonOutputIndex as findLastNonOutputIndex,
  findParentCircuit as findParentCircuit,
  findRungIndexById as findRungIndexById,
  getElementIdsForRung as getElementIdsForRung,
  modifyInstruction as modifyInstruction,
  parseLadderDsl as parseLadderDsl,
  serializeLadderState as serializeLadderState,
  useInstruction as useInstruction,
  useLadderEditor as useLadderEditor,
  useLadderMenuExtras as useLadderMenuExtras,
  useLadderSimulation as useLadderSimulation,
  useLadderTagCatalog as useLadderTagCatalog,
  useRung as useRung,
  useSelection as useSelection
};
