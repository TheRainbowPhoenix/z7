...
/**
 * Performs semantic analysis on the Structured Text (ST) AST.
 * Checks for type mismatches, undefined tags, invalid assignments, and more.
 */
export class SemanticAnalyzer {
    ...
    /**
     * @param {Object} context - Compilation context containing tag definitions.
     * @param {string} [sourceCode] - The original source code for error reporting (line/column).
     */
    constructor(context = {}, sourceCode) {
    ...
    /**
     * Analyzes the AST and returns a list of diagnostics.
     * @param {Object} program - The AST root node.
     * @returns {any[]} List of diagnostics (errors and warnings).
     */
    analyze(program) {
        const diagnostics = [];
