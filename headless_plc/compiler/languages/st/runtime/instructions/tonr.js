...
export function tonr(timer, scanTime) {
    if (typeof timer !== 'object' || timer == null) {
        throw new Error('TONR expects a timer structure');
    }
