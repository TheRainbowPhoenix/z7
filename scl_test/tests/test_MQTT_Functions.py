...
class Test_MQTT_Functions(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.MQTT_Functions as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'mqttGetNextMessageID')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'MQTT_Functions': continue
                try:
