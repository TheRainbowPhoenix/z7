...
class Test_Select_Element_by_Format_Code(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Select_Element_by_Format_Code as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Format_Code_as_Int')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Select_Element_by_Format_Code': continue
                try:
