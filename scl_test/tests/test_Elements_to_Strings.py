...
class Test_Elements_to_Strings(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Elements_to_Strings as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Trim')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Elements_to_Strings': continue
                try:
