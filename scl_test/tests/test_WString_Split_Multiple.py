...
class Test_WString_Split_Multiple(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.WString_Split_Multiple as transpiled_module
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'WString_Split_Multiple': continue
                try:
