...
class Test_WString_Find_Multiple_Breadth(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.WString_Find_Multiple_Breadth as transpiled_module
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'WString_Find_Multiple_Breadth': continue
                try:
