...
class Test_Code_128(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Code_128 as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Code_128')
        ...
        context = DotDict({
            ...
            'pn': '',
            'i': 0,
            'startChar': RecursiveMock(f'startChar'),
            'stopChar': RecursiveMock(f'stopChar'),
        })
