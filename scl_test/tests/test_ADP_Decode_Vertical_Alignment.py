...
class Test_ADP_Decode_Vertical_Alignment(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.ADP_Decode_Vertical_Alignment as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'ADP_Decode_Vertical_Alignment')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'ADP_Decode_Vertical_Alignment': continue
                try:
