...
class Test_Int___CountOfElements(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Int___CountOfElements as transpiled_module
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Int___CountOfElements': continue
                try:
