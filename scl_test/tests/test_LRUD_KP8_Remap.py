...
class Test_LRUD_KP8_Remap(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.LRUD_KP8_Remap as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'LRUD_KP8_Remap')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'LRUD_KP8_Remap': continue
                try:
