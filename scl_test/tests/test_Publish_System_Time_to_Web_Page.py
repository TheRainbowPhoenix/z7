...
class Test_Publish_System_Time_to_Web_Page(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Publish_System_Time_to_Web_Page as transpiled_module
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Publish_System_Time_to_Web_Page': continue
                try:
