...
class Test_Code_128_String_to_Code(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Code_128_String_to_Code as transpiled_module
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Code_128_String_to_Code': continue
                try:
