...
class Test_Nibble_To_String(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Nibble_To_String as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'String_Trim')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Nibble_To_String': continue
                try:
