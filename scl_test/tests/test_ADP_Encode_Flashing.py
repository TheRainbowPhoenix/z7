...
class Test_ADP_Encode_Flashing(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.ADP_Encode_Flashing as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'ADP_Encode_Flashing')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'ADP_Encode_Flashing': continue
                try:
