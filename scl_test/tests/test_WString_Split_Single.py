...
class Test_WString_Split_Single(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.WString_Split_Single as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'WString_Split_Single')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'WString_Split_Single': continue
                try:
