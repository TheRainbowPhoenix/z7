...
class Test_Is_Format_Character(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Is_Format_Character as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Is_Format_Character')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Is_Format_Character': continue
                try:
