...
class Test_DInt_Summation(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.DInt_Summation as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'DInt_Summation')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'DInt_Summation': continue
                try:
