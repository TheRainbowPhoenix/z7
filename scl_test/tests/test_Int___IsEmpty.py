...
class Test_Int___IsEmpty(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Int___IsEmpty as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Int___IsEmpty')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Int___IsEmpty': continue
                try:
