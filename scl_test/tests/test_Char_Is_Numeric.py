...
class Test_Char_Is_Numeric(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Char_Is_Numeric as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Char_Is_Numeric')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Char_Is_Numeric': continue
                try:
