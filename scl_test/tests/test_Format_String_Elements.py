...
class Test_Format_String_Elements(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Format_String_Elements as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Format_String_Elements')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Format_String_Elements': continue
                try:
