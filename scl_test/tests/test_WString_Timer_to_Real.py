...
class Test_WString_Timer_to_Real(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.WString_Timer_to_Real as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'WString_Timer_to_Real')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'WString_Timer_to_Real': continue
                try:
