...
class Test_Real_to_WString_Timer(unittest.TestCase):
    def setUp(self):
    ...
    def test_run(self):
        ...
        import scl_test.transpiled.Real_to_WString_Timer as transpiled_module

        # We need to find the function in the module
        func = getattr(transpiled_module, 'Real_to_WString_Timer')
        ...
        try:
            ...
            for _, name, _ in pkgutil.iter_modules(pkg.__path__):
                if name == 'Real_to_WString_Timer': continue
                try:
