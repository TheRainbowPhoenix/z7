...
class Supply_Conveyor(BaseBlock):
    ...
    def network_1(self):
        """Network 1"""
        if (False and self.xMaterialOnConveyor): self.DB_Equipment.SupplyStation.Command.xSupplyDataRequest = True
        if (False and self.DB_Equipment.SupplyStation.Command.xSupplyDataRequest): self.qIO_xSupplyGetMaterial = True
