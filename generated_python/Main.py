...
class Main(BaseBlock):
    ...
    def network_1(self):
        """Network 1"""
        if True:
            if not isinstance(self.Supply_Conveyor_DB, Supply_Conveyor): self.Supply_Conveyor_DB = Supply_Conveyor()
            self.Supply_Conveyor_DB.run()

    def network_2(self):
        """Network 2"""
        if True:
            if not isinstance(self.Work_Station1_DB, Work_Station): self.Work_Station1_DB = Work_Station()
            ...
            self.Work_Station1_DB.Work_Station_DB = self.DB_Equipment.Station1
            self.Work_Station1_DB.run()
        if True:
            if not isinstance(self.Control_Panel1_DB, Control_Panel): self.Control_Panel1_DB = Control_Panel()
            ...
            self.Control_Panel1_DB.Work_Station_DB = self.DB_Equipment.Station1
            self.Control_Panel1_DB.run()

    def network_3(self):
        """Network 3"""
        if True:
            if not isinstance(self.Work_Station2_DB, Work_Station): self.Work_Station2_DB = Work_Station()
            ...
            self.Work_Station2_DB.Work_Station_DB = self.DB_Equipment.Station2
            self.Work_Station2_DB.run()
        if True:
            if not isinstance(self.Control_Panel2_DB, Control_Panel): self.Control_Panel2_DB = Control_Panel()
            ...
            self.Control_Panel2_DB.Work_Station_DB = self.DB_Equipment.Station2
            self.Control_Panel2_DB.run()

    def network_4(self):
        """Network 4"""
        if True:
            if not isinstance(self.Work_Station3_DB, Work_Station): self.Work_Station3_DB = Work_Station()
            ...
            self.Work_Station3_DB.Work_Station_DB = self.DB_Equipment.Station3
            self.Work_Station3_DB.run()
        if True:
            if not isinstance(self.Control_Panel3_DB, Control_Panel): self.Control_Panel3_DB = Control_Panel()
            ...
            self.Control_Panel3_DB.Work_Station_DB = self.DB_Equipment.Station3
            self.Control_Panel3_DB.run()

    def network_5(self):
        """Network 5"""
        if True:
            if not isinstance(self.Sequence_Data_Management_DB, Sequence_Data_Management): self.Sequence_Data_Management_DB = Sequence_Data_Management()
