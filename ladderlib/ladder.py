...
LADDER_FN_IOCD = {
    ...
    LadderInstructions.LADDER_INS_TON: LadderInstructionIOCD(1, 1, 1, 2),
    LadderInstructions.LADDER_INS_TOF: LadderInstructionIOCD(1, 1, 1, 2),
    LadderInstructions.LADDER_INS_TP: LadderInstructionIOCD(1, 1, 1, 2),
